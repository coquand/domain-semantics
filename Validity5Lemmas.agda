{-# OPTIONS --without-K #-}
module Validity5Lemmas where
open import Validity5Sup public
...
open import SubstitutionLemmaSigma using (typing-ConvTm ; typing-type ; ctx-conv-ConvTm ; ctx-conv-HasType ;
  subst1-cong-ConvTm)
