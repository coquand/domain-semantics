...
------------------------------------------------------------------------
-- Validity.agda  (NAT/ — Pi + U fragment)
--
...
module NAT.Validity.Core where
...
open import NAT.Syntax.Typing using (Ctx ; empty ; extend ; ConvTm ;
  conv-sym ; conv-trans)
open import NAT.Syntax.Reduction using (Red ; mkRed ; HeadRed ; HeadRed-trans ;
  HeadRed-App ;
  HeadRed-strip-Pi ; HeadRed-unique-Pi)
open import NAT.Domain.Kernel using (applyEl ; EvalFun ; EvalFun-step ;
  ...
  LeFunCode-refl)
open import NAT.Model.Selection public
open import NAT.Model.Eval using (absurd)
