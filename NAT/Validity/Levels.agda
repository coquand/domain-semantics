{-# OPTIONS --without-K #-}
------------------------------------------------------------------------
-- ValidityLevels.agda  (NAT/ — Pi + U fragment)
--
...
module NAT.Validity.Levels where
...
open import NAT.Domain.Kernel using (Coherent ; FinMem ; LeCode ; Comp ; Sup)
open import NAT.Domain.Rank using (RANK ; Le-max-lub ; RANK-Sup)
open import NAT.Validity.Stratified
open import NAT.Validity.Stability using (vtyU ; vtyD ; evtyU ; evtyD ; vlU ; vlD ; evlU ; evlD)
open import NAT.Validity.Mono using (MonoPack ; goodStage)
open import NAT.Validity.Props using (FwdPack ; goodStageFwd ; SymTransPack ; goodStageSymTrans ; SupPack ; goodStageSup ; ReflPack ; goodStageRefl ; TransportPack ; goodStageTransport ; BetaPack ; goodStageBeta)
