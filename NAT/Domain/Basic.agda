...
------------------------------------------------------------------------
-- Basic.agda  (NAT/ — Pi + U fragment only)
--
...
mutual
  data FinEl : Set where
    ...
    NatCode  : FinEl            -- the type Nat (a base type, member of U)
    ZeroEl   : FinEl            -- the value 0
    SucEl    : FinEl -> FinEl   -- the value S of an element
