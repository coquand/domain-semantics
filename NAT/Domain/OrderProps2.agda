...
------------------------------------------------------------------------
-- LeqStageProps2.agda  (NAT/ — Pi + U fragment)
--
...
module NAT.Domain.OrderProps2 where
...
open import NAT.Domain.OrderComp
open import NAT.Domain.OrderProps
  ...
  Comp-down-n (suc m) (PiCode a f) (PiCode b g) (PiCode c2 k) cu cu' le comp =
    mkSigma
      ...
      (LeFunCode-CompFun-trans-n m f g k
        ...
        (snd le) (snd comp))
  Comp-down-n zero NatCode Bot          v cu cu' () c
  Comp-down-n zero NatCode UCode        v cu cu' () c
  Comp-down-n zero NatCode (FunEl h)    v cu cu' () c
  Comp-down-n zero NatCode (PiCode b g) v cu cu' () c
  Comp-down-n zero NatCode NatCode      v cu cu' le c = c
  Comp-down-n zero NatCode ZeroEl       v cu cu' () c
  Comp-down-n zero NatCode (SucEl a')   v cu cu' () c
  Comp-down-n (suc m) NatCode Bot          v cu cu' () c
  Comp-down-n (suc m) NatCode UCode        v cu cu' () c
  Comp-down-n (suc m) NatCode (FunEl h)    v cu cu' () c
  Comp-down-n (suc m) NatCode (PiCode b g) v cu cu' () c
  Comp-down-n (suc m) NatCode NatCode      v cu cu' le c = c
  Comp-down-n (suc m) NatCode ZeroEl       v cu cu' () c
  Comp-down-n (suc m) NatCode (SucEl a')   v cu cu' () c
  Comp-down-n zero ZeroEl Bot          v cu cu' () c
  Comp-down-n zero ZeroEl UCode        v cu cu' () c
  Comp-down-n zero ZeroEl (FunEl h)    v cu cu' () c
  Comp-down-n zero ZeroEl (PiCode b g) v cu cu' () c
  Comp-down-n zero ZeroEl NatCode      v cu cu' () c
  Comp-down-n zero ZeroEl ZeroEl       v cu cu' le c = c
  Comp-down-n zero ZeroEl (SucEl a')   v cu cu' () c
  Comp-down-n (suc m) ZeroEl Bot          v cu cu' () c
  Comp-down-n (suc m) ZeroEl UCode        v cu cu' () c
  Comp-down-n (suc m) ZeroEl (FunEl h)    v cu cu' () c
  Comp-down-n (suc m) ZeroEl (PiCode b g) v cu cu' () c
  Comp-down-n (suc m) ZeroEl NatCode      v cu cu' () c
  Comp-down-n (suc m) ZeroEl ZeroEl       v cu cu' le c = c
  Comp-down-n (suc m) ZeroEl (SucEl a')   v cu cu' () c
  Comp-down-n zero (SucEl a) u'           v () cu' le c
  Comp-down-n (suc m) (SucEl a) Bot          v cu cu' () c
  Comp-down-n (suc m) (SucEl a) UCode        v cu cu' () c
  Comp-down-n (suc m) (SucEl a) (FunEl h)    v cu cu' () c
  Comp-down-n (suc m) (SucEl a) (PiCode b g) v cu cu' () c
  Comp-down-n (suc m) (SucEl a) NatCode      v cu cu' () c
  Comp-down-n (suc m) (SucEl a) ZeroEl       v cu cu' () c
  Comp-down-n (suc m) (SucEl a) (SucEl a') Bot          cu cu' le c = tt
  Comp-down-n (suc m) (SucEl a) (SucEl a') UCode        cu cu' le ()
  Comp-down-n (suc m) (SucEl a) (SucEl a') (FunEl h)    cu cu' le ()
  Comp-down-n (suc m) (SucEl a) (SucEl a') (PiCode b k) cu cu' le ()
  Comp-down-n (suc m) (SucEl a) (SucEl a') NatCode      cu cu' le ()
  Comp-down-n (suc m) (SucEl a) (SucEl a') ZeroEl       cu cu' le ()
  Comp-down-n (suc m) (SucEl a) (SucEl a') (SucEl b')   cu cu' le c =
    Comp-down-n m a a' b' cu cu' le c
...
mutual
  ...
  LeCode-refl-n zero    NatCode    cond ca = tt
  LeCode-refl-n (suc m) NatCode    cond ca = tt
  LeCode-refl-n zero    ZeroEl     cond ca = tt
  LeCode-refl-n (suc m) ZeroEl     cond ca = tt
  LeCode-refl-n zero    (SucEl a)  ()   ca
  LeCode-refl-n (suc m) (SucEl a)  cond ca = LeCode-refl-n m a cond ca
  ...
  LeCode-Sup-left-n zero    NatCode Bot     ba bb comp ca cb = tt
  LeCode-Sup-left-n (suc m) NatCode Bot     ba bb comp ca cb = tt
  LeCode-Sup-left-n zero    NatCode NatCode ba bb comp ca cb = tt
  LeCode-Sup-left-n (suc m) NatCode NatCode ba bb comp ca cb = tt
  LeCode-Sup-left-n n NatCode UCode        ba bb () ca cb
  LeCode-Sup-left-n n NatCode (FunEl h)    ba bb () ca cb
  LeCode-Sup-left-n n NatCode (PiCode d h) ba bb () ca cb
  LeCode-Sup-left-n n NatCode ZeroEl       ba bb () ca cb
  LeCode-Sup-left-n n NatCode (SucEl b)    ba bb () ca cb
  LeCode-Sup-left-n zero    ZeroEl Bot    ba bb comp ca cb = tt
  LeCode-Sup-left-n (suc m) ZeroEl Bot    ba bb comp ca cb = tt
  LeCode-Sup-left-n zero    ZeroEl ZeroEl ba bb comp ca cb = tt
  LeCode-Sup-left-n (suc m) ZeroEl ZeroEl ba bb comp ca cb = tt
  LeCode-Sup-left-n n ZeroEl UCode        ba bb () ca cb
  LeCode-Sup-left-n n ZeroEl (FunEl h)    ba bb () ca cb
  LeCode-Sup-left-n n ZeroEl (PiCode d h) ba bb () ca cb
  LeCode-Sup-left-n n ZeroEl NatCode      ba bb () ca cb
  LeCode-Sup-left-n n ZeroEl (SucEl b)    ba bb () ca cb
  LeCode-Sup-left-n zero    (SucEl a) b            ()  bb comp ca cb
  LeCode-Sup-left-n (suc m) (SucEl a) Bot          ba bb comp ca cb =
    LeCode-refl-n (suc m) (SucEl a) ba ca
  LeCode-Sup-left-n (suc m) (SucEl a) UCode        ba bb () ca cb
  LeCode-Sup-left-n (suc m) (SucEl a) (FunEl h)    ba bb () ca cb
  LeCode-Sup-left-n (suc m) (SucEl a) (PiCode d h) ba bb () ca cb
  LeCode-Sup-left-n (suc m) (SucEl a) NatCode      ba bb () ca cb
  LeCode-Sup-left-n (suc m) (SucEl a) ZeroEl       ba bb () ca cb
  LeCode-Sup-left-n (suc m) (SucEl a) (SucEl b)    ba bb comp ca cb =
    LeCode-Sup-left-n m a b ba bb comp ca cb
  ...
  LeCode-Sup-right-n (suc m) (PiCode a f) (PiCode d h) ba bb comp ca cb =
    mkSigma
      ...
      (LeFunCode-append-right-n m f h
        (max-Le-r (RANK a) (RANKFun f) m ba) (max-Le-r (RANK d) (RANKFun h) m bb)
        (snd comp) (snd ca) (snd cb))
  LeCode-Sup-right-n zero    Bot     NatCode ba bb comp ca cb = tt
  LeCode-Sup-right-n (suc m) Bot     NatCode ba bb comp ca cb = tt
  LeCode-Sup-right-n zero    NatCode NatCode ba bb comp ca cb = tt
  LeCode-Sup-right-n (suc m) NatCode NatCode ba bb comp ca cb = tt
  LeCode-Sup-right-n n UCode        NatCode ba bb () ca cb
  LeCode-Sup-right-n n (FunEl g)    NatCode ba bb () ca cb
  LeCode-Sup-right-n n (PiCode a f) NatCode ba bb () ca cb
  LeCode-Sup-right-n n ZeroEl       NatCode ba bb () ca cb
  LeCode-Sup-right-n n (SucEl a)    NatCode ba bb () ca cb
  LeCode-Sup-right-n zero    Bot    ZeroEl ba bb comp ca cb = tt
  LeCode-Sup-right-n (suc m) Bot    ZeroEl ba bb comp ca cb = tt
  LeCode-Sup-right-n zero    ZeroEl ZeroEl ba bb comp ca cb = tt
  LeCode-Sup-right-n (suc m) ZeroEl ZeroEl ba bb comp ca cb = tt
  LeCode-Sup-right-n n UCode        ZeroEl ba bb () ca cb
  LeCode-Sup-right-n n (FunEl g)    ZeroEl ba bb () ca cb
  LeCode-Sup-right-n n (PiCode a f) ZeroEl ba bb () ca cb
  LeCode-Sup-right-n n NatCode      ZeroEl ba bb () ca cb
  LeCode-Sup-right-n n (SucEl a)    ZeroEl ba bb () ca cb
  LeCode-Sup-right-n zero    a            (SucEl b) ba () comp ca cb
  LeCode-Sup-right-n (suc m) Bot          (SucEl b) ba bb comp ca cb =
    LeCode-refl-n (suc m) (SucEl b) bb cb
  LeCode-Sup-right-n (suc m) UCode        (SucEl b) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (FunEl g)    (SucEl b) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (PiCode a f) (SucEl b) ba bb () ca cb
  LeCode-Sup-right-n (suc m) NatCode      (SucEl b) ba bb () ca cb
  LeCode-Sup-right-n (suc m) ZeroEl       (SucEl b) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (SucEl a)    (SucEl b) ba bb comp ca cb =
    LeCode-Sup-right-n m a b ba bb comp ca cb
  ...
  -- x = UCode, new y : xy absurd (n split)
  LeCode-trans-n zero    UCode NatCode     z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) UCode NatCode     z bx by bz cx cy cz () yz
  LeCode-trans-n zero    UCode ZeroEl      z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) UCode ZeroEl      z bx by bz cx cy cz () yz
  LeCode-trans-n zero    UCode (SucEl y)   z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) UCode (SucEl y)   z bx by bz cx cy cz () yz
  -- x = NatCode
  LeCode-trans-n n NatCode NatCode      z bx by bz cx cy cz xy yz = yz
  LeCode-trans-n zero    NatCode Bot          z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) NatCode Bot          z bx by bz cx cy cz () yz
  LeCode-trans-n zero    NatCode UCode        z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) NatCode UCode        z bx by bz cx cy cz () yz
  LeCode-trans-n zero    NatCode (FunEl h)    z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) NatCode (FunEl h)    z bx by bz cx cy cz () yz
  LeCode-trans-n zero    NatCode (PiCode b g) z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) NatCode (PiCode b g) z bx by bz cx cy cz () yz
  LeCode-trans-n zero    NatCode ZeroEl       z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) NatCode ZeroEl       z bx by bz cx cy cz () yz
  LeCode-trans-n zero    NatCode (SucEl y)    z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) NatCode (SucEl y)    z bx by bz cx cy cz () yz
  -- x = ZeroEl
  LeCode-trans-n n ZeroEl ZeroEl       z bx by bz cx cy cz xy yz = yz
  LeCode-trans-n zero    ZeroEl Bot          z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) ZeroEl Bot          z bx by bz cx cy cz () yz
  LeCode-trans-n zero    ZeroEl UCode        z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) ZeroEl UCode        z bx by bz cx cy cz () yz
  LeCode-trans-n zero    ZeroEl (FunEl h)    z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) ZeroEl (FunEl h)    z bx by bz cx cy cz () yz
  LeCode-trans-n zero    ZeroEl (PiCode b g) z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) ZeroEl (PiCode b g) z bx by bz cx cy cz () yz
  LeCode-trans-n zero    ZeroEl NatCode      z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) ZeroEl NatCode      z bx by bz cx cy cz () yz
  LeCode-trans-n zero    ZeroEl (SucEl y)    z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) ZeroEl (SucEl y)    z bx by bz cx cy cz () yz
  -- x = SucEl
  LeCode-trans-n zero    (SucEl x) y z () by bz cx cy cz xy yz
  LeCode-trans-n (suc m) (SucEl x) Bot          z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (SucEl x) UCode        z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (SucEl x) (FunEl h)    z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (SucEl x) (PiCode b g) z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (SucEl x) NatCode      z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (SucEl x) ZeroEl       z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (SucEl x) (SucEl y) Bot          bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (SucEl x) (SucEl y) UCode        bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (SucEl x) (SucEl y) (FunEl k)    bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (SucEl x) (SucEl y) (PiCode c k) bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (SucEl x) (SucEl y) NatCode      bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (SucEl x) (SucEl y) ZeroEl       bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (SucEl x) (SucEl y) (SucEl z)    bx by bz cx cy cz xy yz =
    LeCode-trans-n m x y z bx by bz cx cy cz xy yz
