...
------------------------------------------------------------------------
-- PaperTyping.agda  (NAT/ — Pi + U fragment)
--
...
-- recursion on a stage index in the NAT/FinMemStage* family and collapsed
...
import NAT.Domain.MemProps as P
...
open NAT.Domain.MemUnfold using ( finMemC-bot-to ; finMemC-bot-from )
...
open NAT.Domain.MemUnfold public using ( FinMem-coh-u ; FinMem-a-in-U ; FinMem-coh-a ; coh-from-aU )
