...
------------------------------------------------------------------------
-- LeqStageEval2.agda  (NAT/ — Pi + U fragment)
--
...
module NAT.Domain.OrderEval where
...
open import NAT.Domain.OrderStable using ( leiC-sound )
open import NAT.Domain.OrderBridge
  using ( EvalFun ; EvalFun-step ; LeCode ; LeFunCode ; LeqC-to-LeCode )
open import NAT.Domain.OrderInterface using ( Comp-value-EvalFun )
