...
------------------------------------------------------------------------
-- LeqStageStable.agda  (NAT/ — Pi + U fragment)
--
...
module NAT.Domain.OrderStable where
...
goodStab zero = record { ev-st = evS0 ; lei-st = leiS0 ; lef-st = lefS0 }
  where
    ...
    leiS0 UCode        NatCode       _ = refl
    leiS0 UCode        ZeroEl        _ = refl
    leiS0 UCode        (SucEl _)     ()
    leiS0 (FunEl _)    NatCode       ()
    leiS0 (FunEl _)    ZeroEl        ()
    leiS0 (FunEl _)    (SucEl _)     ()
    leiS0 (PiCode _ _) NatCode       ()
    leiS0 (PiCode _ _) ZeroEl        ()
    leiS0 (PiCode _ _) (SucEl _)     ()
    leiS0 NatCode      Bot           _ = refl
    leiS0 NatCode      UCode         _ = refl
    leiS0 NatCode      (FunEl _)     _ = refl
    leiS0 NatCode      (PiCode _ _)  _ = refl
    leiS0 NatCode      NatCode       _ = refl
    leiS0 NatCode      ZeroEl        _ = refl
    leiS0 NatCode      (SucEl _)     _ = refl
    leiS0 ZeroEl       Bot           _ = refl
    leiS0 ZeroEl       UCode         _ = refl
    leiS0 ZeroEl       (FunEl _)     _ = refl
    leiS0 ZeroEl       (PiCode _ _)  _ = refl
    leiS0 ZeroEl       NatCode       _ = refl
    leiS0 ZeroEl       ZeroEl        _ = refl
    leiS0 ZeroEl       (SucEl _)     _ = refl
    leiS0 (SucEl u)    Bot           ()
    leiS0 (SucEl u)    UCode         ()
    leiS0 (SucEl u)    (FunEl _)     ()
    leiS0 (SucEl u)    (PiCode _ _)  ()
    leiS0 (SucEl u)    NatCode       ()
    leiS0 (SucEl u)    ZeroEl        ()
    leiS0 (SucEl u)    (SucEl _)     ()
...
goodStab (suc m) = record { ev-st = evS ; lei-st = leiS ; lef-st = lefS }
  where
    ...
    leiS UCode        NatCode       _    = refl
    leiS UCode        ZeroEl        _    = refl
    leiS UCode        (SucEl _)     _    = refl
    leiS (FunEl _)    NatCode       _    = refl
    leiS (FunEl _)    ZeroEl        _    = refl
    leiS (FunEl _)    (SucEl _)     _    = refl
    leiS (PiCode _ _) NatCode       _    = refl
    leiS (PiCode _ _) ZeroEl        _    = refl
    leiS (PiCode _ _) (SucEl _)     _    = refl
    leiS NatCode      Bot           _    = refl
    leiS NatCode      UCode         _    = refl
    leiS NatCode      (FunEl _)     _    = refl
    leiS NatCode      (PiCode _ _)  _    = refl
    leiS NatCode      NatCode       _    = refl
    leiS NatCode      ZeroEl        _    = refl
    leiS NatCode      (SucEl _)     _    = refl
    leiS ZeroEl       Bot           _    = refl
    leiS ZeroEl       UCode         _    = refl
    leiS ZeroEl       (FunEl _)     _    = refl
    leiS ZeroEl       (PiCode _ _)  _    = refl
    leiS ZeroEl       NatCode       _    = refl
    leiS ZeroEl       ZeroEl        _    = refl
    leiS ZeroEl       (SucEl _)     _    = refl
    leiS (SucEl u)    Bot           _    = refl
    leiS (SucEl u)    UCode         _    = refl
    leiS (SucEl u)    (FunEl _)     _    = refl
    leiS (SucEl u)    (PiCode _ _)  _    = refl
    leiS (SucEl u)    NatCode       _    = refl
    leiS (SucEl u)    ZeroEl        _    = refl
    leiS (SucEl u)    (SucEl w)     cond = ihlei u w cond
