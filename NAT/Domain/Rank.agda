...
RANK-Sup ZeroEl       (SucEl y)     = tt
RANK-Sup (SucEl x)    Bot           = Le-refl (RANK (SucEl x))
RANK-Sup (SucEl x)    UCode         = tt
RANK-Sup (SucEl x)    (FunEl g)     = tt
RANK-Sup (SucEl x)    (PiCode b g)  = tt
RANK-Sup (SucEl x)    NatCode       = tt
RANK-Sup (SucEl x)    ZeroEl        = tt
RANK-Sup (SucEl x)    (SucEl y)     = RANK-Sup x y
...
RANK-applyEl NatCode      v ()
RANK-applyEl ZeroEl       v ()
RANK-applyEl (SucEl a)    v ()
