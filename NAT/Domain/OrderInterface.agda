...
------------------------------------------------------------------------
-- LeqStageInterface.agda  (NAT/ — Pi + U fragment)
--
...
module NAT.Domain.OrderInterface where
...
open import NAT.Domain.OrderProps  using ( leq-Sup-lub )
open import NAT.Domain.OrderProps2
open import NAT.Domain.OrderStable
open import NAT.Domain.OrderLaws
open import NAT.Domain.OrderBridge
