...
------------------------------------------------------------------------
-- FinMemStageUnfold.agda  (NAT/ — Pi + U fragment)
--
...
module NAT.Domain.MemUnfold where
...
open import NAT.Domain.MemShift
...
finMemC-bot-to NatCode      mem = mem
finMemC-bot-to ZeroEl       mem = mem
finMemC-bot-to (SucEl g)    mem = mem
...
finMemC-bot-from NatCode      mem = mem
finMemC-bot-from ZeroEl       mem = mem
finMemC-bot-from (SucEl g)    mem = mem
...
FinMem-coh-u NatCode Bot          ()
FinMem-coh-u NatCode UCode        mem = tt
FinMem-coh-u NatCode (FunEl g)    ()
FinMem-coh-u NatCode (PiCode a f) ()
FinMem-coh-u NatCode NatCode      ()
FinMem-coh-u NatCode ZeroEl       ()
FinMem-coh-u NatCode (SucEl g)    ()
FinMem-coh-u ZeroEl Bot          ()
FinMem-coh-u ZeroEl UCode        ()
FinMem-coh-u ZeroEl (FunEl g)    ()
FinMem-coh-u ZeroEl (PiCode a f) ()
FinMem-coh-u ZeroEl NatCode      mem = tt
FinMem-coh-u ZeroEl ZeroEl       ()
FinMem-coh-u ZeroEl (SucEl g)    ()
FinMem-coh-u (SucEl v) Bot          ()
FinMem-coh-u (SucEl v) UCode        ()
FinMem-coh-u (SucEl v) (FunEl g)    ()
FinMem-coh-u (SucEl v) (PiCode a f) ()
FinMem-coh-u (SucEl v) NatCode      mem =
  FinMem-coh-u v NatCode
    (finMemC-from (suc (RANK v)) v NatCode
      (Le-suc (RANK v) (RANK v) (Le-refl (RANK v))) (Le0 (suc (RANK v))) mem)
FinMem-coh-u (SucEl v) ZeroEl       ()
FinMem-coh-u (SucEl v) (SucEl g)    ()
...
FinMem-a-in-U NatCode Bot          ()
FinMem-a-in-U NatCode UCode        mem = tt
FinMem-a-in-U NatCode (FunEl g)    ()
FinMem-a-in-U NatCode (PiCode a f) ()
FinMem-a-in-U NatCode NatCode      ()
FinMem-a-in-U NatCode ZeroEl       ()
FinMem-a-in-U NatCode (SucEl g)    ()
FinMem-a-in-U ZeroEl Bot          ()
FinMem-a-in-U ZeroEl UCode        ()
FinMem-a-in-U ZeroEl (FunEl g)    ()
FinMem-a-in-U ZeroEl (PiCode a f) ()
FinMem-a-in-U ZeroEl NatCode      mem = tt
FinMem-a-in-U ZeroEl ZeroEl       ()
FinMem-a-in-U ZeroEl (SucEl g)    ()
FinMem-a-in-U (SucEl v) Bot          ()
FinMem-a-in-U (SucEl v) UCode        ()
FinMem-a-in-U (SucEl v) (FunEl g)    ()
FinMem-a-in-U (SucEl v) (PiCode a f) ()
FinMem-a-in-U (SucEl v) NatCode      mem = tt
FinMem-a-in-U (SucEl v) ZeroEl       ()
FinMem-a-in-U (SucEl v) (SucEl g)    ()
