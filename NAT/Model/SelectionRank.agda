...
module NAT.Model.SelectionRank where

open import NAT.Domain.Basic
  using (FinEl ; Bot ; FinFun ; nil ; cons ; fst ; snd ; tt ; max ;
         Le ; Le-trans ; Le-max-l ; Le-max-r)
open import NAT.Domain.Kernel using (Sup)
open import NAT.Model.Selection using (Selection ; sel-nil ; sel-skip ; sel-take ; Edge)
open import NAT.Domain.Rank using (RANK ; RANKFun ; RANK-Sup ; Le-max-lub)
