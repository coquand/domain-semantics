...
open import NAT.Syntax.Raw using ( Expr ; U ; Pi ; Lam ; App ; NatT ; Zero ; Suc ; Case ; wkExpr ; subst1 )
open import NAT.Syntax.Typing using
  ( Ctx ; extend ; HasType ; ConvTm
  ; ty-conv ; ty-Pi ; ty-Lam ; ty-App ; ty-NatT ; ty-Suc ; ty-Case
  ; conv-refl ; conv-trans )
open import NAT.Syntax.Reduction using ( HeadRed1 ; headred-beta ; headred-app
  ; headred-case-zero ; headred-case-suc ; headred-case )
open import NAT.Syntax.Substitution using
  ( typing-WfCtx ; subst-HasType ; subst1-WtSub ; subst1-wk ; wk-HasType
