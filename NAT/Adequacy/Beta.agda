...
------------------------------------------------------------------------
-- AdequacyBeta.agda  (NAT/ -- PROTOTYPE)
--
...
module NAT.Adequacy.Beta where
open import NAT.Adequacy.HeadRed

open import NAT.Adequacy.Pi using (Adq)

import NAT.Domain.Basic as S
open S using (Nat ; suc ; tt ; mkSigma ; fst ; snd ; FinEl)
open import NAT.Domain.Kernel using (FinMem ; Comp ; Sup ; Coherent-Sup ;
...
open import NAT.Syntax.Raw using (Expr ; U ; Pi ; Lam ; App ; subst1 ; Sub ; liftSub ; substExpr)
open import NAT.Syntax.Typing using (Ctx ; extend ; HasType ; ConvTm ; WfCtx ; wf-extend ;
  conv-beta ; conv-refl)
open import NAT.Syntax.Reduction using (HeadRed ; headred-step ; headred-beta ; headred-refl ; subst-subst1-comm)
open import NAT.Syntax.Substitution using (WtSub ; subst-HasType ; liftSub-WtSub ; typing-ConvTm)
