...
------------------------------------------------------------------------
-- AdequacyAppInj.agda  (NAT/ -- PROTOTYPE)
--
...
module NAT.Adequacy.AppInj where
...
open import NAT.Syntax.Reduction using (Red ; mkRed ; Red-refl ; HeadRed ; headred-step ; headred-beta ; headred-refl ; subst-subst1-comm)
open import NAT.Model.Eval using (EnvApprox ; extendEnv ; EvalRel ; EvalRel-coh ; CoherentEnv ; EvalRel-Comp ; EvalRel-down ; EvalRel-mon-env ; EnvLe ; EnvLe-refl)
open import NAT.Syntax.Raw using (Expr ; Var ; U ; Pi ; Lam ; App ; Fin ; fzero ; fsuc ; wkExpr ; subst1 ; Sub ; liftSub ; substExpr ; subst1Sub)
open import NAT.Syntax.Typing using (Ctx ; extend ; HasType ; ConvTm ; WfCtx ; wf-extend ; ty-var ; ty-conv ; ty-U ; conv-refl ; conv-sym ; conv-conv)
open import NAT.Validity.Core using (Selection ; Coherent-Selection ; Coherent-Selection-val ; FinMem-Coherent)
open import NAT.Validity.Core using () renaming (Red-unique-Pi to Red-unique-Pi2)
open import NAT.Model.Selection using (FinMemAllU-Selection ; selectionBelow ; FinMem-Selection ; FinMem-Selection-codomain)
open import NAT.Model.EvalSubstitution using (EvalRel-subst1-backward ; EvalRel-body-EvalFun ; EvalRel-Pi-app-type ; EvalRel-subst1-forward)
open import NAT.Model.Soundness using (convSound' ; theorem1)
open import NAT.Syntax.Substitution using (typing-ConvTm ; WtSub ; subst-HasType ; subst-ConvTm ; liftSub-WtSub ; typing-WfCtx ; typing-type ; subst1-cong-ConvTm ; WtConvSub ; subst-ConvTm-cross)
open import NAT.Model.SoundnessLemmas using (Fits)
open import NAT.Adequacy.App using (AdSub2Rec ; AdConvSub2Rec ; app-transport-EqVal2)
open import NAT.Adequacy.Pi using (Val2-U-to-ValTy2)
...
adequacyV-ty-App-inj {H = H} {A = A} {B = B} {f = f0} {a = a} dA dB df da adSub2 sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH funcross argsingle argcross (FunEl gfe) hu (PiCode bacfe facfe) evA fm =
  adequacyConvSub2-App-core-body-inj {H = H} {A = A} {B = B} {f = f0} {a = a}
    ...
    adSub2 funcross argsingle argcross Val2-U-to-ValTy2 app-transport-EqVal2
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ Bot _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ (FunEl _) _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ (PiCode _ _) _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ NatCode _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ ZeroEl _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ (SucEl _) _ ()
adequacyV-ty-App-inj {H = H} {A = A} {B = B} {f = f0} {a = a} dA dB df da adSub2 sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH funcross argsingle argcross NatCode hu UCode evA fm =
  adequacyConvSub2-App-core-body-inj {H = H} {A = A} {B = B} {f = f0} {a = a}
    dA dB df da sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH
    NatCode (fst hu) (fst (snd hu)) (snd (snd hu)) UCode evA fm
    adSub2 funcross argsingle argcross Val2-U-to-ValTy2 app-transport-EqVal2
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ Bot _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ UCode _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ (FunEl _) _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ (PiCode _ _) _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ ZeroEl _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ (SucEl _) _ ()
adequacyV-ty-App-inj {H = H} {A = A} {B = B} {f = f0} {a = a} dA dB df da adSub2 sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH funcross argsingle argcross ZeroEl hu NatCode evA fm =
  adequacyConvSub2-App-core-body-inj {H = H} {A = A} {B = B} {f = f0} {a = a}
    dA dB df da sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH
    ZeroEl (fst hu) (fst (snd hu)) (snd (snd hu)) NatCode evA fm
    adSub2 funcross argsingle argcross Val2-U-to-ValTy2 app-transport-EqVal2
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ Bot _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ UCode _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ (FunEl _) _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ (PiCode _ _) _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ ZeroEl _ ()
adequacyV-ty-App-inj _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ (SucEl _) _ ()
adequacyV-ty-App-inj {H = H} {A = A} {B = B} {f = f0} {a = a} dA dB df da adSub2 sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH funcross argsingle argcross (SucEl vsuc) hu NatCode evA fm =
  adequacyConvSub2-App-core-body-inj {H = H} {A = A} {B = B} {f = f0} {a = a}
    dA dB df da sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH
