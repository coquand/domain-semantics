...
------------------------------------------------------------------------
-- AdequacyLam.agda  (NAT/ -- PROTOTYPE)
--
...
module NAT.Adequacy.Lam where

open import NAT.Adequacy.HeadRed
open import NAT.Adequacy.Pi using (Adq ; AdqConv ; transportVal2' ; transportEqVal2' ;
  Val2-U-to-ValTy2 ; EqVal2-U-to-EqValTy2)
open import NAT.Adequacy.VE using (adequacyV-ty-Pi)
...
open import NAT.Syntax.Raw using (Expr ; U ; Pi ; Lam ; subst1 ; Sub ; liftSub ; substExpr)
...
open import NAT.Syntax.Reduction using (headred-refl ; headred-step ; headred-beta)
open import NAT.Model.Selection using (FinMem-Selection ; FinMem-Selection-codomain ; Coherent-Selection)
open import NAT.Model.EvalSubstitution using (EvalRel-Pi-body)
