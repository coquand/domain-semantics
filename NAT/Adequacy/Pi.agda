...
open import NAT.Domain.Kernel using (LeCode ; LeCode-refl ; Coherent ; Comp ;
...
open import NAT.Syntax.Substitution using (WtSub ; WtConvSub ; subst-HasType ; liftSub-WtSub)
open import NAT.Model.EvalSubstitution using (EvalRel-unwk ; EvalRel-Pi-body)
...
Val2-U-to-ValTy2 NatCode _ v = snd v
Val2-U-to-ValTy2 (FunEl _) () _
Val2-U-to-ValTy2 ZeroEl () _
Val2-U-to-ValTy2 (SucEl _) () _
...
EqVal2-U-to-EqValTy2 NatCode _ ev = snd (snd (snd ev))
EqVal2-U-to-EqValTy2 (FunEl _) () _
EqVal2-U-to-EqValTy2 ZeroEl () _
EqVal2-U-to-EqValTy2 (SucEl _) () _
    ...
    buildEdgeVal u0 v0 sel N htN valN =
      let fm_u0_b  = FinMemAllU-Selection b sel allU cf cb bU
          ...
          hyp0     = \ u' cu' le_u' a_arg evA_arg fm_u'_a ->
                       transportVal2' IH-A sigma rho crho vs fits wtsub wfH b bU evAb u0 fm_u0_b N valN u' cu' le_u' a_arg evA_arg fm_u'_a
    ...
    buildEdgeEq u0 v0 sel N1 N2 htN1 htN2 cvN eqvalN =
      let fm_u0_b  = FinMemAllU-Selection b sel allU cf cb bU
          ...
          hyp0_N1  = \ u' cu' le_u' a_arg evA_arg fm_u'_a ->
                       transportVal2' IH-A sigma rho crho vs fits wtsub wfH b bU evAb u0 fm_u0_b N1 valN1 u' cu' le_u' a_arg evA_arg fm_u'_a
          ...
          hyp0_N2  = \ u' cu' le_u' a_arg evA_arg fm_u'_a ->
                       transportVal2' IH-A sigma rho crho vs fits wtsub wfH b bU evAb u0 fm_u0_b N2 valN2 u' cu' le_u' a_arg evA_arg fm_u'_a
          ...
          vcs_ext  = ValidConvSub2-extend sigma sigma N1 N2 rho u0
                       ...
                       (transportEqVal2' IH-A sigma rho crho vs fits wtsub wfH b bU evAb u0 fm_u0_b eqvalN)
