...
------------------------------------------------------------------------
-- AdequacyArgCore.agda  (NAT/ -- PROTOTYPE)
--
...
module NAT.Adequacy.ArgCore where
...
open import NAT.Syntax.Reduction using (Red ; mkRed ; Red-refl ; HeadRed ; headred-step ; headred-beta ;
...
open import NAT.Syntax.Raw using (Expr ; Var ; U ; Pi ; Lam ; App ; Fin ; fzero ; fsuc ; wkExpr ;
  subst1 ; Sub ; liftSub ; substExpr ; subst1Sub)
open import NAT.Syntax.Typing using (Ctx ; extend ; HasType ; ConvTm ; WfCtx ; wf-extend ; ty-var ;
...
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ Bot _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ (FunEl _) _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ (PiCode _ _) _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ NatCode _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ ZeroEl _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ (SucEl _) _ ()
adequacyEqSub2-App-arg {H = H} dB df daa' sigma rho crho vs fits wtsub wfH IHfv IHBv IHaae NatCode ev UCode evAc fm =
  adequacyEqSub2-App-arg-core-body {H = H} dB df daa' sigma rho crho vs fits wtsub wfH NatCode
    (fst ev) (fst (snd ev)) (snd (snd ev)) UCode evAc fm IHfv IHBv IHaae
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ Bot _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ UCode _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ (FunEl _) _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ (PiCode _ _) _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ ZeroEl _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ (SucEl _) _ ()
adequacyEqSub2-App-arg {H = H} dB df daa' sigma rho crho vs fits wtsub wfH IHfv IHBv IHaae ZeroEl ev NatCode evAc fm =
  adequacyEqSub2-App-arg-core-body {H = H} dB df daa' sigma rho crho vs fits wtsub wfH ZeroEl
    (fst ev) (fst (snd ev)) (snd (snd ev)) NatCode evAc fm IHfv IHBv IHaae
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ Bot _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ UCode _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ (FunEl _) _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ (PiCode _ _) _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ ZeroEl _ ()
adequacyEqSub2-App-arg _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ (SucEl _) _ ()
adequacyEqSub2-App-arg {H = H} dB df daa' sigma rho crho vs fits wtsub wfH IHfv IHBv IHaae (SucEl vsuc) ev NatCode evAc fm =
  adequacyEqSub2-App-arg-core-body {H = H} dB df daa' sigma rho crho vs fits wtsub wfH (SucEl vsuc)
    (fst ev) (fst (snd ev)) (snd (snd ev)) NatCode evAc fm IHfv IHBv IHaae
