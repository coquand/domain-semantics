...
------------------------------------------------------------------------
-- AdequacyBundle.agda  (NAT/ -- PROTOTYPE, phase 2)
--
...
module NAT.Adequacy.Bundle where

open import NAT.Adequacy.HeadRed
open import NAT.Adequacy.VE public

import NAT.Domain.Basic as S
open S using (Nat ; zero ; suc ; tt ; Pair ; mkSigma ; fst ; snd ; FinEl ; UCode ; Bot ; FunEl ; PiCode)
open import NAT.Syntax.Raw using (Expr ; Var ; U ; Pi ; Lam ; App ; subst1 ; Fin ; fzero ; fsuc ; Sub ; liftSub ; substExpr ; wkExpr)
open import NAT.Model.Eval using (EnvApprox ; EvalRel ; CoherentEnv ; lookupEnv ; extendEnv ;
  EvalRel-Comp ; EvalRel-mon-env ; EvalRel-down ; EnvLe-refl)
open import NAT.Domain.Kernel using (Coherent ; FinMem ; LeCode ; LeCode-refl ; FinMem-a-in-U ;
...
open import NAT.Syntax.Typing using (Ctx ; lookup ; HasType ; ConvTm ; WfCtx ; wf-extend ; ty-var ;
  ty-U ; ty-Pi ; ty-Lam ; ty-conv ; conv-refl ; conv-sym ; conv-conv)
open import NAT.Model.Selection using (FinMemAllU-Selection ; FinMem-Selection-UCode)
open import NAT.Adequacy.Pi using (EqVal2-U-to-EqValTy2 ; AdqConv ; Adq ; transportVal2' ;
  Val2-U-to-ValTy2 ; sup-transport-EqVal2 ; adequacy-ty-Pi)
open import NAT.Domain.Basic using (FinFun)
open import NAT.Adequacy.Lam using (adequacyV-ty-Lam ; lamTypeTwoSub ; adequacy-ty-Lam)
open import NAT.Adequacy.App using (adequacyV-ty-App ; adequacyV-subst1-cod ; AdSub2Rec ; AdConvSub2Rec)
open import NAT.Adequacy.AppInj using (adequacyV-ty-App-inj ; adequacyV-subst1-cod-inj)
open import NAT.Adequacy.ArgCore using (adequacyEqSub2-App-arg ; AdEqSub2Rec)
...
open import NAT.Syntax.Reduction using (headred-refl)
open import NAT.Syntax.Substitution using (WtSub ; WtConvSub ; typing-ConvTm ; subst-HasType ;
...
open import NAT.Model.Eval using (EvalRel-coh)
open import NAT.Model.Soundness using (convSound ; convSound-inv)
open import NAT.Validity.Core using (FinMem-Coherent)
open import NAT.Model.EvalSubstitution using (EvalRel-unwk)
open import NAT.Syntax.Typing using (extend)
