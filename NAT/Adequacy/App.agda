...
------------------------------------------------------------------------
-- AdequacyApp.agda  (NAT/ -- PROTOTYPE)
--
...
module NAT.Adequacy.App where

open import NAT.Adequacy.HeadRed
open import NAT.Adequacy.Cases using (adequacyConvSub2-App-core-body ; adequacySub2-App-core-body)
...
open S using (Nat ; zero ; suc ; tt ; mkSigma ; fst ; snd ; FinEl ; Bot ; UCode ; FunEl ; PiCode ;
  NatCode ; ZeroEl ; SucEl ; FinFun ; List ; nil ; cons)
open import NAT.Domain.Kernel using (LeCode ; Coherent ; coh-from-aU ; FinMem ; FinMem-coh-u ;
  Comp ; Sup ; LeCode-Sup-left ; LeCode-Sup-right ; Coherent-Sup ;
  finMemUCode-Sup ; finMem-upward)
open import NAT.Model.Eval using (EnvApprox ; extendEnv ; EvalRel ; CoherentEnv ;
  EvalRel-coh ; EvalRel-mon-env ; EvalRel-down ; EnvLe-refl)
open import NAT.Syntax.Raw using (Expr ; U ; App ; Pi ; subst1 ; Sub ; liftSub ; substExpr)
open import NAT.Syntax.Typing using (Ctx ; extend ; HasType ; WfCtx)
open import NAT.Syntax.Substitution using (WtSub ; WtConvSub ; subst-HasType ; subst-ConvTm-cross)
open import NAT.Model.SoundnessLemmas using (Fits)
open import NAT.Model.Soundness using (theorem1)
open import NAT.Model.EvalSubstitution using (EvalRel-subst1-forward)
open import NAT.Syntax.Reduction using (subst-subst1-comm)
...
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ Bot _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ (FunEl _) _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ (PiCode _ _) _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ NatCode _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ ZeroEl _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ (SucEl _) _ ()
adequacyV-ty-App {H = H} {A = A} {B = B} {f = f0} {a = a} dA dB df da IHav IHBv IHfc IHac sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH NatCode hu UCode evA fm =
  adequacyConvSub2-App-core-body {H = H} {A = A} {B = B} {f = f0} {a = a}
    dA dB df da sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH
    NatCode (fst hu) (fst (snd hu)) (snd (snd hu)) UCode evA fm
    IHav IHBv IHfc IHac Val2-U-to-ValTy2 app-transport-EqVal2
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ Bot _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ UCode _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ (FunEl _) _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ (PiCode _ _) _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ ZeroEl _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ (SucEl _) _ ()
adequacyV-ty-App {H = H} {A = A} {B = B} {f = f0} {a = a} dA dB df da IHav IHBv IHfc IHac sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH ZeroEl hu NatCode evA fm =
  adequacyConvSub2-App-core-body {H = H} {A = A} {B = B} {f = f0} {a = a}
    dA dB df da sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH
    ZeroEl (fst hu) (fst (snd hu)) (snd (snd hu)) NatCode evA fm
    IHav IHBv IHfc IHac Val2-U-to-ValTy2 app-transport-EqVal2
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ Bot _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ UCode _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ (FunEl _) _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ (PiCode _ _) _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ ZeroEl _ ()
adequacyV-ty-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ (SucEl _) _ ()
adequacyV-ty-App {H = H} {A = A} {B = B} {f = f0} {a = a} dA dB df da IHav IHBv IHfc IHac sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH (SucEl vsuc) hu NatCode evA fm =
  adequacyConvSub2-App-core-body {H = H} {A = A} {B = B} {f = f0} {a = a}
    dA dB df da sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH
    (SucEl vsuc) (fst hu) (fst (snd hu)) (snd (snd hu)) NatCode evA fm
    IHav IHBv IHfc IHac Val2-U-to-ValTy2 app-transport-EqVal2
...
adequacySub2-App {H = H} dA dB d1 d2 IHf IHa IHB sigma rho crho vs fits wtsub wfH (FunEl gfe) cu1 ev1 (PiCode bacfe facfe) evAc1 fm1 =
  adequacySub2-App-core-body {H = H} dA dB d1 d2 sigma rho crho vs fits wtsub wfH (FunEl gfe) cu1
    ...
    IHf IHa IHB Val2-U-to-ValTy2 app-transport-Val2
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ _ Bot _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ _ (FunEl _) _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ _ (PiCode _ _) _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ _ NatCode _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ _ ZeroEl _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ NatCode _ _ (SucEl _) _ ()
adequacySub2-App {H = H} dA dB d1 d2 IHf IHa IHB sigma rho crho vs fits wtsub wfH NatCode cu1 ev1 UCode evAc1 fm1 =
  adequacySub2-App-core-body {H = H} dA dB d1 d2 sigma rho crho vs fits wtsub wfH NatCode cu1
    (fst ev1) (fst (snd ev1)) (snd (snd ev1)) UCode evAc1 fm1
    IHf IHa IHB Val2-U-to-ValTy2 app-transport-Val2
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ _ Bot _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ _ UCode _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ _ (FunEl _) _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ _ (PiCode _ _) _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ _ ZeroEl _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ ZeroEl _ _ (SucEl _) _ ()
adequacySub2-App {H = H} dA dB d1 d2 IHf IHa IHB sigma rho crho vs fits wtsub wfH ZeroEl cu1 ev1 NatCode evAc1 fm1 =
  adequacySub2-App-core-body {H = H} dA dB d1 d2 sigma rho crho vs fits wtsub wfH ZeroEl cu1
    (fst ev1) (fst (snd ev1)) (snd (snd ev1)) NatCode evAc1 fm1
    IHf IHa IHB Val2-U-to-ValTy2 app-transport-Val2
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ _ Bot _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ _ UCode _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ _ (FunEl _) _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ _ (PiCode _ _) _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ _ ZeroEl _ ()
adequacySub2-App _ _ _ _ _ _ _ _ _ _ _ _ _ _ (SucEl vsuc) _ _ (SucEl _) _ ()
adequacySub2-App {H = H} dA dB d1 d2 IHf IHa IHB sigma rho crho vs fits wtsub wfH (SucEl vsuc) cu1 ev1 NatCode evAc1 fm1 =
  adequacySub2-App-core-body {H = H} dA dB d1 d2 sigma rho crho vs fits wtsub wfH (SucEl vsuc) cu1
    (fst ev1) (fst (snd ev1)) (snd (snd ev1)) NatCode evAc1 fm1
    IHf IHa IHB Val2-U-to-ValTy2 app-transport-Val2
