...
open import MIN.AdequacyPi using (Adq ; AdqConv ; transportVal2' ; transportEqVal2' ;
  Val2-U-to-ValTy2 ; EqVal2-U-to-EqValTy2)
open import MIN.AdequacyVE using (adequacyV-ty-Pi)
...
open import MIN.RawSyntax using (Expr ; U ; Pi ; Lam ; subst1 ; Sub ; liftSub ; substExpr)
...
open import MIN.Reduction using (headred-refl ; headred-step ; headred-beta)
open import MIN.Selection using (FinMem-Selection ; FinMem-Selection-codomain ; Coherent-Selection)
open import MIN.EvalSubstitution using (EvalRel-Pi-body)
