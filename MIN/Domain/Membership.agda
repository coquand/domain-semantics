...
import MIN.Domain.MemProps as P
...
open MIN.Domain.MemUnfold using ( finMemC-bot-to ; finMemC-bot-from )
...
open MIN.Domain.MemUnfold public using ( FinMem-coh-u ; FinMem-a-in-U ; FinMem-coh-a ; coh-from-aU )
