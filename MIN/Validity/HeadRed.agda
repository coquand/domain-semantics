...
module MIN.Validity.HeadRed where

open import MIN.Validity.Mono
open import MIN.Validity.Props using (BetaPack ; goodStageBeta)
open import MIN.Validity.Stratified using (Red3 ; mkRed3 ; Val2 ; EqVal2)
...
open import MIN.Syntax.Raw using (Expr ; U ; Pi ; App ; subst1)
open import MIN.Syntax.Typing using (Ctx ; extend ; HasType ; ConvTm ;
  conv-refl ; conv-sym ; conv-trans ; conv-conv ; conv-App-fun)
open import MIN.Syntax.Reduction using (HeadRed ; HeadRed1 ; HeadRed1-det ;
  headred-refl ; headred-step ; HeadRed-trans ; HeadRed-App ; HeadRed-strip-Pi)
open import MIN.Domain.Kernel using (EvalFun)
open import MIN.Syntax.Substitution using (typing-ConvTm ; typing-type ; subst1-cong-ConvTm)
