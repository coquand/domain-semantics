...
module MIN.SubstitutionLemma where

open import MIN.Basic using (Nat ; zero ; suc ; Eq ; refl ; Eq-cong ;
  Eq-transport ; Eq-sym ; Pair ; mkSigma ; fst ; snd)
open import MIN.RawSyntax using (Fin ; fzero ; fsuc ;
...
open import MIN.Reduction using (idSub ; substExpr-id ; subst-subst1-comm)
