...
open import MIN.AdequacyPi using (Adq ; AdqConv ; adequacy-ty-Pi ;
...
open import MIN.PaperSemantics using (LeCode ; LeCode-refl ; Coherent ; coh-from-aU ;
...
open import MIN.SubstitutionLemma using (WtSub ; WtConvSub ; subst-HasType ; typing-ConvTm ;
