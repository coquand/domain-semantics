...
module MIN.Adequacy.App where

open import MIN.Adequacy.HeadRed
open import MIN.Adequacy.Cases using (adequacyConvSub2-App-core-body ; adequacySub2-App-core-body)
open import MIN.Adequacy.Pi using (Adq ; AdqConv ; Val2-U-to-ValTy2)
...
open import MIN.Domain.Kernel using (LeCode ; Coherent ; coh-from-aU ; FinMem ; FinMem-coh-u ;
...
open import MIN.Syntax.Raw using (Expr ; U ; App ; Pi ; subst1 ; Sub ; liftSub ; substExpr)
open import MIN.Syntax.Typing using (Ctx ; extend ; HasType ; WfCtx)
open import MIN.Syntax.Substitution using (WtSub ; WtConvSub ; subst-HasType ; subst-ConvTm-cross)
open import MIN.Model.SoundnessLemmas using (Fits)
open import MIN.Model.Soundness using (theorem1)
open import MIN.Model.EvalSubstitution using (EvalRel-subst1-forward)
open import MIN.Syntax.Reduction using (subst-subst1-comm)
