...
module MIN.Adequacy.VE where

open import MIN.Adequacy.HeadRed
open import MIN.Adequacy.Pi using (Adq ; AdqConv ; adequacy-ty-Pi ;
...
open import MIN.Model.Eval using (EnvApprox ; extendEnv ; EvalRel ; EvalRel-coh ;
  CoherentEnv ; EvalRel-Comp)
open import MIN.Model.Soundness using (convSound ; convSound-inv)
open import MIN.Syntax.Raw using (Expr ; U ; Pi ; subst1 ; Sub ; liftSub ; substExpr)
...
open import MIN.Syntax.Substitution using (WtSub ; WtConvSub ; subst-HasType ; typing-ConvTm ;
...
open import MIN.Model.Eval using (EvalRel-mon-env ; EnvLe-refl)
...
open import MIN.Syntax.Typing using (ty-conv)
