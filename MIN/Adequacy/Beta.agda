...
module MIN.Adequacy.Beta where
open import MIN.Adequacy.HeadRed

open import MIN.Adequacy.Pi using (Adq)

import MIN.Domain.Basic as S
open S using (Nat ; suc ; tt ; mkSigma ; fst ; snd ; FinEl)
open import MIN.Domain.Kernel using (FinMem ; Comp ; Sup ; Coherent-Sup ;
...
open import MIN.Syntax.Raw using (Expr ; U ; Pi ; Lam ; App ; subst1 ; Sub ; liftSub ; substExpr)
open import MIN.Syntax.Typing using (Ctx ; extend ; HasType ; ConvTm ; WfCtx ; wf-extend ;
  conv-beta ; conv-refl)
open import MIN.Syntax.Reduction using (HeadRed ; headred-step ; headred-beta ; headred-refl ; subst-subst1-comm)
open import MIN.Syntax.Substitution using (WtSub ; subst-HasType ; liftSub-WtSub ; typing-ConvTm)
