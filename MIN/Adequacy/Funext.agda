...
module MIN.Adequacy.Funext where
open import MIN.Adequacy.HeadRed

open import MIN.Adequacy.App using (AdSub2Rec)
open import MIN.Adequacy.ArgCore using (AdEqSub2Rec)
open import MIN.Adequacy.Pi using (Adq ; transportVal2')
open import MIN.Adequacy.VE using (AdqE1)

import MIN.Domain.Basic as S
open S using (Nat ; suc ; tt ; mkSigma ; fst ; snd ; FinEl ; Bot ; UCode ; FunEl ; PiCode ; FinFun ; nil ; cons)
open import MIN.Domain.Kernel using (LeCode ; LeCode-refl ; Coherent ; EvalFun ; FinMem ;
...
open import MIN.Syntax.Raw using (Expr ; Var ; U ; Pi ; Lam ; App ; fzero ; wkExpr ; subst1 ;
...
open import MIN.Syntax.Substitution using (WtSub ; subst-HasType ; liftSub-WtSub)
open import MIN.Model.Soundness using (convSound)
open import MIN.Model.EvalSubstitution using (EvalRel-Pi-body ; EvalRel-wk)
open import MIN.Validity.Core using (Selection ; Coherent-Selection ; Coherent-Selection-val ;
  Selection-le-EvalFun)
open import MIN.Model.Selection using (FinMem-Selection ; FinMem-Selection-codomain)
