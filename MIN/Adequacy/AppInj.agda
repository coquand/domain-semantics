...
module MIN.Adequacy.AppInj where
...
open import MIN.Adequacy.App using (AdSub2Rec ; AdConvSub2Rec ; app-transport-EqVal2)
open import MIN.Adequacy.Pi using (Val2-U-to-ValTy2)
