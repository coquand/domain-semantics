...
-- head-expansion family (MIN.Validity.HeadRed).
--
...
module MIN.Adequacy.HeadRed where
open import MIN.Adequacy.Helpers public
open import MIN.Validity.HeadRed public
  using (Val2-headred-contract ; EqVal2-headred-contract ; EqVal2-headred-expand)

open import MIN.Domain.Basic using (Nat ; FinEl)
