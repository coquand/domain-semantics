...
module MIN.Adequacy.Value where

import MIN.Domain.Basic as S
open S using (Nat ; tt ; mkSigma ; fst ; snd ; FinEl ; Bot ; UCode ; FunEl ; PiCode)
open import MIN.Syntax.Raw using (Expr ; U ; Pi ; Lam ; App ; Fin ; Sub ; substExpr ; subst1)
open import MIN.Domain.Kernel using (LeCode ; LeCode-refl ; FinMem ; FinMem-a-in-U)
open import MIN.Model.Eval using (EnvApprox ; EvalRel ; EvalRel-coh ; CoherentEnv)
open import MIN.Syntax.Typing using (Ctx ; extend ; lookup ; HasType ; ConvTm ; WfCtx ;
...
open import MIN.Syntax.Substitution using (WtSub ; WtConvSub)
open import MIN.Adequacy.HeadRed
open import MIN.Adequacy.Bundle
open import MIN.Adequacy.Pi using (Adq ; AdqConv ; Val2-U-to-ValTy2 ; EqVal2-U-to-EqValTy2)
open import MIN.Adequacy.App using (adequacySub2-App ; adequacyV-ty-App)
open import MIN.Adequacy.Lam using (adequacyV-ty-Lam)
...
open import MIN.Adequacy.ArgCore using (adequacyEqSub2-App-arg)
