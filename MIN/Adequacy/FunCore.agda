...
module MIN.Adequacy.FunCore where
open import MIN.Adequacy.HeadRed

open import MIN.Adequacy.Cases using (adequacyEqSub2-App-fun-core-body)
...
open S using (Nat ; suc ; tt ; mkSigma ; fst ; snd ; FinEl ; Bot ; UCode ; FunEl ; PiCode)
open import MIN.Domain.Kernel using (FinMem)
open import MIN.Model.Eval using (EnvApprox ; EvalRel ; CoherentEnv)
open import MIN.Syntax.Raw using (Expr ; U ; Pi ; App ; subst1 ; Sub ; substExpr)
open import MIN.Syntax.Typing using (Ctx ; extend ; HasType ; ConvTm ; WfCtx)
open import MIN.Syntax.Substitution using (WtSub)
