...
module MIN.Adequacy.ArgCore where
open import MIN.Adequacy.HeadRed

open import MIN.Adequacy.App using (app-transport-EqVal2)
open import MIN.Adequacy.Pi using (Val2-U-to-ValTy2 ; Adq)
...
open import MIN.Syntax.Reduction using (Red ; mkRed ; Red-refl ; HeadRed ; headred-step ; headred-beta ;
  headred-refl ; subst-subst1-comm)
open import MIN.Model.Eval using (EnvApprox ; extendEnv ; EvalRel ; EvalRel-coh ; CoherentEnv ;
  EvalRel-Comp ; EvalRel-down ; EvalRel-mon-env ; EnvLe ; EnvLe-refl)
open import MIN.Syntax.Raw using (Expr ; Var ; U ; Pi ; Lam ; App ; Fin ; fzero ; fsuc ; wkExpr ;
  subst1 ; Sub ; liftSub ; substExpr ; subst1Sub)
open import MIN.Syntax.Typing using (Ctx ; extend ; HasType ; ConvTm ; WfCtx ; wf-extend ; ty-var ;
...
open import MIN.Model.Selection using (FinMemAllU-Selection ; selectionBelow ; FinMem-Selection ;
  FinMem-Selection-codomain)
open import MIN.Model.EvalSubstitution using (EvalRel-Pi-app-type ; EvalRel-subst1-forward)
open import MIN.Model.Soundness using (convSound' ; theorem1)
open import MIN.Syntax.Substitution using (typing-ConvTm ; WtSub ; subst-HasType ; subst-ConvTm ;
