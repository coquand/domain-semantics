...
module MIN.Adequacy.Bundle where

open import MIN.Adequacy.HeadRed
open import MIN.Adequacy.VE public

import MIN.Domain.Basic as S
open S using (Nat ; zero ; suc ; tt ; Pair ; mkSigma ; fst ; snd ; FinEl ; UCode ; Bot ; FunEl ; PiCode)
open import MIN.Syntax.Raw using (Expr ; Var ; U ; Pi ; Lam ; App ; subst1 ; Fin ; fzero ; fsuc ; Sub ; liftSub ; substExpr ; wkExpr)
open import MIN.Model.Eval using (EnvApprox ; EvalRel ; CoherentEnv ; lookupEnv ; extendEnv ;
  EvalRel-Comp ; EvalRel-mon-env ; EvalRel-down ; EnvLe-refl)
open import MIN.Domain.Kernel using (Coherent ; FinMem ; LeCode ; LeCode-refl ; FinMem-a-in-U ;
...
open import MIN.Syntax.Typing using (Ctx ; lookup ; HasType ; ConvTm ; WfCtx ; wf-extend ; ty-var ;
  ty-U ; ty-Pi ; ty-Lam ; ty-conv ; conv-refl ; conv-sym ; conv-conv)
open import MIN.Model.Selection using (FinMemAllU-Selection ; FinMem-Selection-UCode)
open import MIN.Adequacy.Pi using (EqVal2-U-to-EqValTy2 ; AdqConv ; Adq ; transportVal2' ;
  Val2-U-to-ValTy2 ; sup-transport-EqVal2 ; adequacy-ty-Pi)
open import MIN.Domain.Basic using (FinFun)
open import MIN.Adequacy.Lam using (adequacyV-ty-Lam ; lamTypeTwoSub ; adequacy-ty-Lam)
open import MIN.Adequacy.App using (adequacyV-ty-App ; adequacyV-subst1-cod ; AdSub2Rec ; AdConvSub2Rec)
open import MIN.Adequacy.AppInj using (adequacyV-ty-App-inj ; adequacyV-subst1-cod-inj)
open import MIN.Adequacy.ArgCore using (adequacyEqSub2-App-arg ; AdEqSub2Rec)
open import MIN.Adequacy.Beta using (adequacyEqSub2-beta)
open import MIN.Adequacy.Funext using (adequacyEqSub2-funext)
open import MIN.Adequacy.FunCore using (adequacyEqSub2-App-fun)
open import MIN.Syntax.Reduction using (headred-refl)
open import MIN.Syntax.Substitution using (WtSub ; WtConvSub ; typing-ConvTm ; subst-HasType ;
...
open import MIN.Model.Eval using (EvalRel-coh)
open import MIN.Model.Soundness using (convSound ; convSound-inv)
open import MIN.Validity.Core using (FinMem-Coherent)
open import MIN.Model.EvalSubstitution using (EvalRel-unwk)
open import MIN.Syntax.Typing using (extend)
