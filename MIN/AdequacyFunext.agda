...
open import MIN.AdequacyApp using (AdSub2Rec)
open import MIN.AdequacyArgCore using (AdEqSub2Rec)
open import MIN.AdequacyPi using (Adq ; transportVal2')
...
open import MIN.PaperSemantics using (LeCode ; LeCode-refl ; Coherent ; EvalFun ; FinMem ;
...
open import MIN.RawSyntax using (Expr ; Var ; U ; Pi ; Lam ; App ; fzero ; wkExpr ; subst1 ;
...
open import MIN.SubstitutionLemma using (WtSub ; subst-HasType ; liftSub-WtSub)
open import MIN.TypingSemantics using (convSound)
open import MIN.EvalSubstitution using (EvalRel-Pi-body ; EvalRel-wk)
open import MIN.Validity using (Selection ; Coherent-Selection ; Coherent-Selection-val ;
  Selection-le-EvalFun)
open import MIN.Selection using (FinMem-Selection ; FinMem-Selection-codomain)
