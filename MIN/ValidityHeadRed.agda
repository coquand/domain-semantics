...
open import MIN.ValidityMono
open import MIN.ValidityProps using (BetaPack ; goodStageBeta)
open import MIN.ValidityStratified using (Red3 ; mkRed3 ; Val2 ; EqVal2)
...
open import MIN.Reduction using (HeadRed ; HeadRed1 ; HeadRed1-det ;
  headred-refl ; headred-step ; HeadRed-trans ; HeadRed-App ; HeadRed-strip-Pi)
open import MIN.PaperSemantics using (EvalFun)
open import MIN.SubstitutionLemma using (typing-ConvTm ; typing-type ; subst1-cong-ConvTm)
