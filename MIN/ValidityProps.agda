...
-- same combinator+induction way as MIN.ValidityMono:
...
open import MIN.ValidityStratified using (Red3 ; mkRed3)
...
open import MIN.SubstitutionLemma using (typing-ConvTm ; typing-type ; ctx-conv-ConvTm ; ctx-conv-HasType ;
  subst1-cong-ConvTm)
