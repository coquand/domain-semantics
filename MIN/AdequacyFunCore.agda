...
open import MIN.AdequacyCases using (adequacyEqSub2-App-fun-core-body)
...
open import MIN.PaperSemantics using (FinMem)
open import MIN.RawSemantics using (EnvApprox ; EvalRel ; CoherentEnv)
open import MIN.RawSyntax using (Expr ; U ; Pi ; App ; subst1 ; Sub ; substExpr)
open import MIN.TypingRules using (Ctx ; extend ; HasType ; ConvTm ; WfCtx)
open import MIN.SubstitutionLemma using (WtSub)
