...
module MIN.Model.SoundnessLemmas where
...
open import MIN.Domain.Kernel using (LeCode ; LeCode-refl ; LeCode-trans ; LeCode-Bot ;
...
open CFTcons
open import MIN.Model.Selection using (Selection ; Edge ; EdgeIn ; here ; there ;
