...
module MIN.Model.EvalSubstitution where
...
open import MIN.Domain.Kernel using (LeCode ; LeCode-refl ; LeCode-trans ;
...
open import MIN.Model.Selection using (Edge ; EdgeIn ; here ; there ; Selection ;
