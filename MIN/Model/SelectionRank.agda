...
module MIN.Model.SelectionRank where

open import MIN.Domain.Basic
  using (FinEl ; Bot ; FinFun ; nil ; cons ; fst ; snd ; tt ; max ;
         Le ; Le-trans ; Le-max-l ; Le-max-r)
open import MIN.Domain.Kernel using (Sup)
open import MIN.Model.Selection using (Selection ; sel-nil ; sel-skip ; sel-take ; Edge)
open import MIN.Domain.Rank using (RANK ; RANKFun ; RANK-Sup ; Le-max-lub)
