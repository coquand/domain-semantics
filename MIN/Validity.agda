...
open import MIN.TypingRules using (Ctx ; empty ; extend ; ConvTm ;
  conv-sym ; conv-trans)
open import MIN.Reduction using (Red ; mkRed ; HeadRed ; HeadRed-trans ;
  HeadRed-App ;
  HeadRed-strip-Pi ; HeadRed-unique-Pi)
open import MIN.PaperSemantics using (applyEl ; EvalFun ; EvalFun-step ;
  ...
  LeFunCode-refl)
open import MIN.Selection public
open import MIN.RawSemantics using (absurd)
