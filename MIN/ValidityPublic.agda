...
open import MIN.ValidityMono using (MonoPack ; goodStage) public
open import MIN.ValidityMono using (Red3-unique-Pi) public

-- property lemmas whose *-pub signature already matches the originals
open import MIN.ValidityLevels public
