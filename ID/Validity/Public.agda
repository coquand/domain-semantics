...
open import ID.Adequacy.Records public
  renaming ( RValTyPiP   to RValTyPi
           ...
           ; RValTyIdP   to RValTyId
           ; REqValTyIdP to REqValTyId )

-- Red3-unique-Pi over ValidityStratified.Red3
open import ID.Validity.Mono using (MonoPack ; goodStage) public
open import ID.Validity.Mono using (Red3-unique-Pi) public

-- property lemmas whose *-pub signature already matches the originals
open import ID.Validity.Levels public
  ...
  renaming ( downVal2-pub          to downVal2
           ...
           ; Val2-Sup-pub          to Val2-Sup
           ; EqVal2-Sup-pub        to EqVal2-Sup
