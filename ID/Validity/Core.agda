...
open import ID.Syntax.Typing using (Ctx ; empty ; extend ; ConvTm ;
  conv-sym ; conv-trans)
open import ID.Syntax.Reduction using (Red ; mkRed ; HeadRed ; HeadRed-trans ;
  HeadRed-App ;
  HeadRed-strip-Pi ; HeadRed-unique-Pi)
open import ID.Domain.Kernel using (applyEl ; EvalFun ; EvalFun-step ;
  ...
  LeFunCode-refl)
open import ID.Model.Selection public
open import ID.Model.Eval using (absurd)
