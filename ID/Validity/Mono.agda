...
open RS using (Expr ; Var ; U ; Pi ; Lam ; App ; Id ; Ref ; J ;
...
open import ID.Syntax.Reduction using (Red ; mkRed ; Red-hr ; HeadRed ; headred-refl ; HeadRed-trans ;
  HeadRed-App ;
  HeadRed-strip-Pi ; HeadRed-unique-Id )
...
open import ID.Domain.Membership using (finMem-ref-wit ; finMem-ref-le1 ; finMem-ref-le2)
...
open import ID.Validity.Core using (Red-unique-Pi ;
  bU-from-cf-fmFun ;
  FinMem-Coherent)
open import ID.Syntax.Substitution using (typing-ConvTm ; ctx-conv-ConvTm ; ctx-conv-HasType ;
  subst1-cong-ConvTm)
...
Red3-unique-Id : {n : Nat} {G : Ctx n} {A t t' a a' b b' : Expr n} ->
  Red3 G A (Id t a b) U -> Red3 G A (Id t' a' b') U ->
  Pair (Eq t t') (Pair (Eq a a') (Eq b b'))
Red3-unique-Id r1 r2 = HeadRed-unique-Id (Red3.hr r1) (Red3.hr r2)
...
goodStage (suc n) = record
  ...
  where
    ...
    ihdV   = MonoPack.downVal2 ih
    ihdEV  = MonoPack.downEqVal2 ih
    ihrV   = MonoPack.restrictVal2 ih
    ihrEV  = MonoPack.restrictEqVal2 ih
    ...
    -- type-code lower = RefEl: vl _ u (RefEl w) = Top
    dV G M T u (RefEl w) a1 le mem ca0 ca1 src = tt
    -- type-code lower = IdCode: only Bot / RefEl values inhabit it
    dV G M T Bot            (IdCode t0' u0' v0') a1 le mem ca0 ca1 src = tt
    dV G M T UCode          (IdCode t0' u0' v0') a1 le () ca0 ca1 src
    dV G M T (FunEl g)      (IdCode t0' u0' v0') a1 le () ca0 ca1 src
    dV G M T (PiCode b f)   (IdCode t0' u0' v0') a1 le () ca0 ca1 src
    dV G M T (IdCode s0 s1 s2) (IdCode t0' u0' v0') a1 le () ca0 ca1 src
    dV G M T (RefEl w) (IdCode t0' u0' v0') Bot          ()
    dV G M T (RefEl w) (IdCode t0' u0' v0') UCode        ()
    dV G M T (RefEl w) (IdCode t0' u0' v0') (FunEl h)    ()
    dV G M T (RefEl w) (IdCode t0' u0' v0') (PiCode b f) ()
    dV G M T (RefEl w) (IdCode t0' u0' v0') (RefEl w2)   ()
    dV G M T (RefEl w) (IdCode t0' u0' v0') (IdCode t1' u1' v1') le mem ca0 ca1 src =
      let fmem' = FinMem-a-in-U (RefEl w) (IdCode t0' u0' v0') mem
          vtyP  = dVT G T (IdCode t0' u0' v0') (IdCode t1' u1' v1') le fmem' ca1 (fst src)
          rid   = snd src
          le_t  = fst le
          fm_w  = finMem-ref-wit w t0' u0' v0' mem
          coht0 = coh-from-aU t0' (finMem-idU-dom t0' u0' v0' fmem')
          t1U   = finMem-idU-dom t1' u1' v1' ca1
      in mkSigma vtyP (record
           { domA0 = RValId.domA0 rid ; lhs0 = RValId.lhs0 rid ; rhs0 = RValId.rhs0 rid
           ; red = RValId.red rid ; wit0 = RValId.wit0 rid ; redTm = RValId.redTm rid ; refConvL = RValId.refConvL rid ; refConvR = RValId.refConvR rid
           ; refMem = mem
           ; endEqL = ihdEV G (RValId.wit0 rid) (RValId.lhs0 rid) (RValId.domA0 rid) w t0' t1' le_t fm_w coht0 t1U (RValId.endEqL rid)
           ; endEqR = ihdEV G (RValId.wit0 rid) (RValId.rhs0 rid) (RValId.domA0 rid) w t0' t1' le_t fm_w coht0 t1U (RValId.endEqR rid) })
    ...
    -- type-code lower = RefEl: evl _ u (RefEl w) = Top
    dEV G M N T u (RefEl w) a1 le mem ca0 ca1 src = tt
    -- type-code lower = IdCode
    dEV G M N T Bot            (IdCode t0' u0' v0') a1 le mem ca0 ca1 src = tt
    dEV G M N T UCode          (IdCode t0' u0' v0') a1 le () ca0 ca1 src
    dEV G M N T (FunEl g)      (IdCode t0' u0' v0') a1 le () ca0 ca1 src
    dEV G M N T (PiCode b f)   (IdCode t0' u0' v0') a1 le () ca0 ca1 src
    dEV G M N T (IdCode s0 s1 s2) (IdCode t0' u0' v0') a1 le () ca0 ca1 src
    dEV G M N T (RefEl w) (IdCode t0' u0' v0') Bot          ()
    dEV G M N T (RefEl w) (IdCode t0' u0' v0') UCode        ()
    dEV G M N T (RefEl w) (IdCode t0' u0' v0') (FunEl h)    ()
    dEV G M N T (RefEl w) (IdCode t0' u0' v0') (PiCode b f) ()
    dEV G M N T (RefEl w) (IdCode t0' u0' v0') (RefEl w2)   ()
    dEV G M N T (RefEl w) (IdCode t0' u0' v0') (IdCode t1' u1' v1') le mem ca0 ca1 src =
      let fmem' = FinMem-a-in-U (RefEl w) (IdCode t0' u0' v0') mem
          vtyP  = dVT G T (IdCode t0' u0' v0') (IdCode t1' u1' v1') le fmem' ca1 (fst src)
          ridM  = fst (snd src) ; ridN = fst (snd (snd src)) ; reid = snd (snd (snd src))
          le_t  = fst le
          fm_w  = finMem-ref-wit w t0' u0' v0' mem
          coht0 = coh-from-aU t0' (finMem-idU-dom t0' u0' v0' fmem')
          t1U   = finMem-idU-dom t1' u1' v1' ca1
      in mkSigma vtyP (mkSigma
           (record { domA0 = RValId.domA0 ridM ; lhs0 = RValId.lhs0 ridM ; rhs0 = RValId.rhs0 ridM
                   ; red = RValId.red ridM ; wit0 = RValId.wit0 ridM ; redTm = RValId.redTm ridM ; refConvL = RValId.refConvL ridM ; refConvR = RValId.refConvR ridM
                   ; refMem = mem
                   ; endEqL = ihdEV G (RValId.wit0 ridM) (RValId.lhs0 ridM) (RValId.domA0 ridM) w t0' t1' le_t fm_w coht0 t1U (RValId.endEqL ridM)
                   ; endEqR = ihdEV G (RValId.wit0 ridM) (RValId.rhs0 ridM) (RValId.domA0 ridM) w t0' t1' le_t fm_w coht0 t1U (RValId.endEqR ridM) })
           (mkSigma
             (record { domA0 = RValId.domA0 ridN ; lhs0 = RValId.lhs0 ridN ; rhs0 = RValId.rhs0 ridN
                     ; red = RValId.red ridN ; wit0 = RValId.wit0 ridN ; redTm = RValId.redTm ridN ; refConvL = RValId.refConvL ridN ; refConvR = RValId.refConvR ridN
                     ; refMem = mem
                     ; endEqL = ihdEV G (RValId.wit0 ridN) (RValId.lhs0 ridN) (RValId.domA0 ridN) w t0' t1' le_t fm_w coht0 t1U (RValId.endEqL ridN)
                     ; endEqR = ihdEV G (RValId.wit0 ridN) (RValId.rhs0 ridN) (RValId.domA0 ridN) w t0' t1' le_t fm_w coht0 t1U (RValId.endEqR ridN) })
             (record { domA0 = REqValId.domA0 reid ; lhs0 = REqValId.lhs0 reid ; rhs0 = REqValId.rhs0 reid
                     ; red = REqValId.red reid ; wit0M = REqValId.wit0M reid ; wit0N = REqValId.wit0N reid ; redTmM = REqValId.redTmM reid ; redTmN = REqValId.redTmN reid
                     ; refMem = mem
                     ; endEqLM = ihdEV G (REqValId.wit0M reid) (REqValId.lhs0 reid) (REqValId.domA0 reid) w t0' t1' le_t fm_w coht0 t1U (REqValId.endEqLM reid)
                     ; endEqRM = ihdEV G (REqValId.wit0M reid) (REqValId.rhs0 reid) (REqValId.domA0 reid) w t0' t1' le_t fm_w coht0 t1U (REqValId.endEqRM reid)
                     ; endEqLN = ihdEV G (REqValId.wit0N reid) (REqValId.lhs0 reid) (REqValId.domA0 reid) w t0' t1' le_t fm_w coht0 t1U (REqValId.endEqLN reid)
                     ; endEqRN = ihdEV G (REqValId.wit0N reid) (REqValId.rhs0 reid) (REqValId.domA0 reid) w t0' t1' le_t fm_w coht0 t1U (REqValId.endEqRN reid) })))
    ...
    dVT G M (IdCode t0 u0 v0) Bot          le fmem cu1 src = tt-absurd le
      where tt-absurd : {A : Set} -> Empty -> A
            tt-absurd ()
    dVT G M (IdCode t0 u0 v0) UCode        le fmem cu1 src = tt-absurd le
      where tt-absurd : {A : Set} -> Empty -> A
            tt-absurd ()
    dVT G M (IdCode t0 u0 v0) (FunEl h)    le fmem cu1 src = tt-absurd le
      where tt-absurd : {A : Set} -> Empty -> A
            tt-absurd ()
    dVT G M (IdCode t0 u0 v0) (PiCode b f) le fmem cu1 src = tt-absurd le
      where tt-absurd : {A : Set} -> Empty -> A
            tt-absurd ()
    dVT G M (IdCode t0 u0 v0) (RefEl w)    le fmem cu1 src = tt-absurd le
      where tt-absurd : {A : Set} -> Empty -> A
            tt-absurd ()
    dVT G M (IdCode t0 u0 v0) (IdCode t1 u1 v1) le fmem cu1 src =
      let A = RValTyId.domA src ; L = RValTyId.lhs src ; R = RValTyId.rhs src
          leT = fst le ; leU = fst (snd le) ; leV = snd (snd le)
          t0U = finMem-idU-dom t0 u0 v0 fmem
          u0t0 = finMem-idU-lhs t0 u0 v0 fmem
          v0t0 = finMem-idU-rhs t0 u0 v0 fmem
          t1U = finMem-idU-dom t1 u1 v1 cu1
          u1t1 = finMem-idU-lhs t1 u1 v1 cu1
          v1t1 = finMem-idU-rhs t1 u1 v1 cu1
          ct0 = coh-from-aU t0 t0U ; ct1 = coh-from-aU t1 t1U
          u0t1 = finMem-upward u0 t0 t1 leT ct0 ct1 u0t0 t1U
          v0t1 = finMem-upward v0 t0 t1 leT ct0 ct1 v0t0 t1U
          valA0 = ihdVT G A t0 t1 leT t0U t1U (RValTyId.valA src)
          -- membership endpoints: read straight off fmem.
          valL0 = u0t0
          valR0 = v0t0
          valLlog0 = ihdV G L A u0 t0 t1 leT u0t0 ct0 t1U (ihrV G L A u1 u0 t1 leU u0t1 u1t1 (RValTyId.valLlog src))
          valRlog0 = ihdV G R A v0 t0 t1 leT v0t0 ct0 t1U (ihrV G R A v1 v0 t1 leV v0t1 v1t1 (RValTyId.valRlog src))
      in record
        { domA = A ; lhs = L ; rhs = R
        ; red = RValTyId.red src
        ; htA = RValTyId.htA src ; htL = RValTyId.htL src ; htR = RValTyId.htR src
        ; valA = valA0 ; valL = valL0 ; valR = valR0
        ; valLlog = valLlog0 ; valRlog = valRlog0
        }
    ...
    dEVT G M N (IdCode t0 u0 v0) Bot          le fmem cu1 src = idabs le
      where idabs : {A : Set} -> Empty -> A
            idabs ()
    dEVT G M N (IdCode t0 u0 v0) UCode        le fmem cu1 src = idabs le
      where idabs : {A : Set} -> Empty -> A
            idabs ()
    dEVT G M N (IdCode t0 u0 v0) (FunEl h)    le fmem cu1 src = idabs le
      where idabs : {A : Set} -> Empty -> A
            idabs ()
    dEVT G M N (IdCode t0 u0 v0) (PiCode b f) le fmem cu1 src = idabs le
      where idabs : {A : Set} -> Empty -> A
            idabs ()
    dEVT G M N (IdCode t0 u0 v0) (RefEl w)    le fmem cu1 src = idabs le
      where idabs : {A : Set} -> Empty -> A
            idabs ()
    dEVT G M N (IdCode t0 u0 v0) (IdCode t1 u1 v1) le fmem cu1 src =
      let vtM0 = dVT G M (IdCode t0 u0 v0) (IdCode t1 u1 v1) le fmem cu1 (fst src)
          vtN0 = dVT G N (IdCode t0 u0 v0) (IdCode t1 u1 v1) le fmem cu1 (fst (snd src))
          core = snd (snd src)
          A = REqValTyId.domA core ; A' = REqValTyId.domA' core
          L = REqValTyId.lhs core ; L' = REqValTyId.lhs' core
          R = REqValTyId.rhs core ; R' = REqValTyId.rhs' core
          leT = fst le ; leU = fst (snd le) ; leV = snd (snd le)
          t0U = finMem-idU-dom t0 u0 v0 fmem ; u0t0 = finMem-idU-lhs t0 u0 v0 fmem ; v0t0 = finMem-idU-rhs t0 u0 v0 fmem
          t1U = finMem-idU-dom t1 u1 v1 cu1 ; u1t1 = finMem-idU-lhs t1 u1 v1 cu1 ; v1t1 = finMem-idU-rhs t1 u1 v1 cu1
          ct0 = coh-from-aU t0 t0U ; ct1 = coh-from-aU t1 t1U
          u0t1 = finMem-upward u0 t0 t1 leT ct0 ct1 u0t0 t1U
          v0t1 = finMem-upward v0 t0 t1 leT ct0 ct1 v0t0 t1U
          eqA0 = ihdEVT G A A' t0 t1 leT t0U t1U (REqValTyId.eqA core)
          eqL0 = ihdEV G L L' A u0 t0 t1 leT u0t0 ct0 t1U (ihrEV G L L' A u1 u0 t1 leU u0t1 u1t1 (REqValTyId.eqL core))
          eqR0 = ihdEV G R R' A v0 t0 t1 leT v0t0 ct0 t1U (ihrEV G R R' A v1 v0 t1 leV v0t1 v1t1 (REqValTyId.eqR core))
          core0 = record
            { domA = A ; lhs = L ; rhs = R ; domA' = A' ; lhs' = L' ; rhs' = R'
            ; redM = REqValTyId.redM core ; redN = REqValTyId.redN core
            ; convA = REqValTyId.convA core ; convL = REqValTyId.convL core ; convR = REqValTyId.convR core
            ; eqA = eqA0 ; eqL = eqL0 ; eqR = eqR0 }
      in mkSigma vtM0 (mkSigma vtN0 core0)
    ...
    uV G M T Bot a0 (IdCode a1 a2 a3) le mem0 mem1 ca0 ca1 src vta1 = tt
    uV G M T (IdCode u u1 u2) UCode UCode le mem0 mem1 ca0 ca1 src vta1 = src
    uV G M T (RefEl u) Bot          (IdCode a1 a2 a3) le ()
    uV G M T (RefEl u) UCode        (IdCode a1 a2 a3) le ()
    uV G M T (RefEl u) (FunEl h)    (IdCode a1 a2 a3) le ()
    uV G M T (RefEl u) (PiCode b f) (IdCode a1 a2 a3) le ()
    uV G M T (RefEl u) (RefEl w)    (IdCode a1 a2 a3) le ()
    uV G M T (RefEl u) (IdCode s0 s1 s2) (IdCode a1 a2 a3) le mem0 mem1 ca0 ca1 src vta1 =
      let rid   = snd src
          fmem0 = FinMem-a-in-U (RefEl u) (IdCode s0 s1 s2) mem0
          fmem1 = FinMem-a-in-U (RefEl u) (IdCode a1 a2 a3) mem1
          le_t   = fst le
          fm_u_s0 = finMem-ref-wit u s0 s1 s2 mem0
          fm_u_a1 = finMem-ref-wit u a1 a2 a3 mem1
          coh_s0 = coh-from-aU s0 (finMem-idU-dom s0 s1 s2 fmem0)
          coh_a1 = coh-from-aU a1 (finMem-idU-dom a1 a2 a3 fmem1)
          uniqId = Red3-unique-Id (RValId.red rid) (RValTyId.red vta1)
          vtDomA0 = Eq-transport (\ X -> VTy n G X a1) (Eq-sym (fst uniqId)) (RValTyId.valA vta1)
      in mkSigma vta1 (record
        { domA0 = RValId.domA0 rid ; lhs0 = RValId.lhs0 rid ; rhs0 = RValId.rhs0 rid
        ; red = RValId.red rid ; wit0 = RValId.wit0 rid ; redTm = RValId.redTm rid ; refConvL = RValId.refConvL rid ; refConvR = RValId.refConvR rid
        ; refMem = mem1
        ; endEqL = MonoPack.upEqVal2 ih G (RValId.wit0 rid) (RValId.lhs0 rid) (RValId.domA0 rid) u s0 a1 le_t fm_u_s0 fm_u_a1 coh_s0 coh_a1 (RValId.endEqL rid) vtDomA0
        ; endEqR = MonoPack.upEqVal2 ih G (RValId.wit0 rid) (RValId.rhs0 rid) (RValId.domA0 rid) u s0 a1 le_t fm_u_s0 fm_u_a1 coh_s0 coh_a1 (RValId.endEqR rid) vtDomA0 })
    ...
    uEV G M N T Bot a0 (IdCode a1 a2 a3) le mem0 mem1 ca0 ca1 src vta1 = tt
    uEV G M N T (IdCode u u1 u2) UCode UCode le mem0 mem1 ca0 ca1 src vta1 = src
    uEV G M N T (RefEl u) Bot          (IdCode a1 a2 a3) le ()
    uEV G M N T (RefEl u) UCode        (IdCode a1 a2 a3) le ()
    uEV G M N T (RefEl u) (FunEl h)    (IdCode a1 a2 a3) le ()
    uEV G M N T (RefEl u) (PiCode b f) (IdCode a1 a2 a3) le ()
    uEV G M N T (RefEl u) (RefEl w)    (IdCode a1 a2 a3) le ()
    uEV G M N T (RefEl u) (IdCode s0 s1 s2) (IdCode a1 a2 a3) le mem0 mem1 ca0 ca1 src vta1 =
      let ridM = fst (snd src) ; ridN = fst (snd (snd src)) ; reid = snd (snd (snd src))
          fmem0 = FinMem-a-in-U (RefEl u) (IdCode s0 s1 s2) mem0
          fmem1 = FinMem-a-in-U (RefEl u) (IdCode a1 a2 a3) mem1
          le_t   = fst le
          fm_u_s0 = finMem-ref-wit u s0 s1 s2 mem0
          ...
          coh_s0 = coh-from-aU s0 (finMem-idU-dom s0 s1 s2 fmem0)
          coh_a1 = coh-from-aU a1 (finMem-idU-dom a1 a2 a3 fmem1)
          upE = MonoPack.upEqVal2 ih
          vtDomM = Eq-transport (\ X -> VTy n G X a1) (Eq-sym (fst (Red3-unique-Id (RValId.red ridM) (RValTyId.red vta1)))) (RValTyId.valA vta1)
          vtDomN = Eq-transport (\ X -> VTy n G X a1) (Eq-sym (fst (Red3-unique-Id (RValId.red ridN) (RValTyId.red vta1)))) (RValTyId.valA vta1)
          vtDomE = Eq-transport (\ X -> VTy n G X a1) (Eq-sym (fst (Red3-unique-Id (REqValId.red reid) (RValTyId.red vta1)))) (RValTyId.valA vta1)
      in mkSigma vta1
        (mkSigma (record
          { domA0 = RValId.domA0 ridM ; lhs0 = RValId.lhs0 ridM ; rhs0 = RValId.rhs0 ridM
          ; red = RValId.red ridM ; wit0 = RValId.wit0 ridM ; redTm = RValId.redTm ridM ; refConvL = RValId.refConvL ridM ; refConvR = RValId.refConvR ridM
          ; refMem = mem1
          ; endEqL = upE G (RValId.wit0 ridM) (RValId.lhs0 ridM) (RValId.domA0 ridM) u s0 a1 le_t fm_u_s0 fm_u_a1 coh_s0 coh_a1 (RValId.endEqL ridM) vtDomM
          ; endEqR = upE G (RValId.wit0 ridM) (RValId.rhs0 ridM) (RValId.domA0 ridM) u s0 a1 le_t fm_u_s0 fm_u_a1 coh_s0 coh_a1 (RValId.endEqR ridM) vtDomM })
          (mkSigma (record
            { domA0 = RValId.domA0 ridN ; lhs0 = RValId.lhs0 ridN ; rhs0 = RValId.rhs0 ridN
            ; red = RValId.red ridN ; wit0 = RValId.wit0 ridN ; redTm = RValId.redTm ridN ; refConvL = RValId.refConvL ridN ; refConvR = RValId.refConvR ridN
            ; refMem = mem1
            ; endEqL = upE G (RValId.wit0 ridN) (RValId.lhs0 ridN) (RValId.domA0 ridN) u s0 a1 le_t fm_u_s0 fm_u_a1 coh_s0 coh_a1 (RValId.endEqL ridN) vtDomN
            ; endEqR = upE G (RValId.wit0 ridN) (RValId.rhs0 ridN) (RValId.domA0 ridN) u s0 a1 le_t fm_u_s0 fm_u_a1 coh_s0 coh_a1 (RValId.endEqR ridN) vtDomN })
            (record
              { domA0 = REqValId.domA0 reid ; lhs0 = REqValId.lhs0 reid ; rhs0 = REqValId.rhs0 reid
              ; red = REqValId.red reid ; wit0M = REqValId.wit0M reid ; wit0N = REqValId.wit0N reid ; redTmM = REqValId.redTmM reid ; redTmN = REqValId.redTmN reid
              ; refMem = mem1
              ; endEqLM = upE G (REqValId.wit0M reid) (REqValId.lhs0 reid) (REqValId.domA0 reid) u s0 a1 le_t fm_u_s0 fm_u_a1 coh_s0 coh_a1 (REqValId.endEqLM reid) vtDomE
              ; endEqRM = upE G (REqValId.wit0M reid) (REqValId.rhs0 reid) (REqValId.domA0 reid) u s0 a1 le_t fm_u_s0 fm_u_a1 coh_s0 coh_a1 (REqValId.endEqRM reid) vtDomE
              ; endEqLN = upE G (REqValId.wit0N reid) (REqValId.lhs0 reid) (REqValId.domA0 reid) u s0 a1 le_t fm_u_s0 fm_u_a1 coh_s0 coh_a1 (REqValId.endEqLN reid) vtDomE
              ; endEqRN = upE G (REqValId.wit0N reid) (REqValId.rhs0 reid) (REqValId.domA0 reid) u s0 a1 le_t fm_u_s0 fm_u_a1 coh_s0 coh_a1 (REqValId.endEqRN reid) vtDomE })))
    ...
    -- a = RefEl type (nonsense): vl is Top
    rV G M T u u' (RefEl a) le mem fmu src = src
    -- value = IdCode (Id-type-in-U), restricting the type-code at UCode
    rV G M T (IdCode s0 s1 s2) Bot UCode le mem fmu src = tt
    rV G M T (IdCode s0 s1 s2) (IdCode u' u'' u''') UCode le mem fmu src =
      mkSigma (fst src) (dVT G M (IdCode u' u'' u''') (IdCode s0 s1 s2) le mem fmu (snd src))
    rV G M T Bot          (IdCode u' u'' u''') UCode ()
    rV G M T UCode        (IdCode u' u'' u''') UCode ()
    rV G M T (FunEl g)    (IdCode u' u'' u''') UCode ()
    rV G M T (PiCode b f) (IdCode u' u'' u''') UCode ()
    rV G M T (RefEl w)    (IdCode u' u'' u''') UCode ()
    -- a = IdCode type: restrict the proof value (proof-irrelevant)
    rV G M T u Bot            (IdCode a a1 a2) le mem fmu src = tt
    rV G M T u UCode          (IdCode a a1 a2) le mem fmu src = tt
    rV G M T u (FunEl h)      (IdCode a a1 a2) le mem fmu src = tt
    rV G M T u (PiCode b f)   (IdCode a a1 a2) le mem fmu src = tt
    rV G M T u (IdCode s0 s1 s2) (IdCode a a1 a2) le mem fmu src = tt
    rV G M T (RefEl w) (RefEl w') (IdCode a a1 a2) le mem fmu src =
      let rid = snd src
          fm_w' = finMem-ref-wit w' a a1 a2 mem
          fm_w  = finMem-ref-wit w a a1 a2 fmu
      in mkSigma (fst src) (record
        { domA0 = RValId.domA0 rid ; lhs0 = RValId.lhs0 rid ; rhs0 = RValId.rhs0 rid
        ; red = RValId.red rid ; wit0 = RValId.wit0 rid ; redTm = RValId.redTm rid ; refConvL = RValId.refConvL rid ; refConvR = RValId.refConvR rid
        ; refMem = mem
        ; endEqL = ihrEV G (RValId.wit0 rid) (RValId.lhs0 rid) (RValId.domA0 rid) w w' a le fm_w' fm_w (RValId.endEqL rid)
        ; endEqR = ihrEV G (RValId.wit0 rid) (RValId.rhs0 rid) (RValId.domA0 rid) w w' a le fm_w' fm_w (RValId.endEqR rid) })
    rV G M T Bot          (RefEl w') (IdCode a a1 a2) ()
    rV G M T UCode        (RefEl w') (IdCode a a1 a2) ()
    rV G M T (FunEl g)    (RefEl w') (IdCode a a1 a2) ()
    rV G M T (PiCode b f) (RefEl w') (IdCode a a1 a2) ()
    rV G M T (IdCode s0 s1 s2) (RefEl w') (IdCode a a1 a2) ()
    ...
    -- a = RefEl type: evl is Top
    rEV G M N T u u' (RefEl a) le mem fmu src = src
    -- value = IdCode (Id-type-in-U) restriction at UCode
    rEV G M N T (IdCode s0 s1 s2) Bot UCode le mem fmu src = tt
    rEV G M N T (IdCode s0 s1 s2) (IdCode u' u'' u''') UCode le mem fmu (mkSigma vtA (mkSigma vtM (mkSigma vtN eqvt))) =
      mkSigma vtA
        (mkSigma (dVT G M (IdCode u' u'' u''') (IdCode s0 s1 s2) le mem fmu vtM)
          (mkSigma (dVT G N (IdCode u' u'' u''') (IdCode s0 s1 s2) le mem fmu vtN)
            (dEVT G M N (IdCode u' u'' u''') (IdCode s0 s1 s2) le mem fmu eqvt)))
    rEV G M N T Bot          (IdCode u' u'' u''') UCode ()
    rEV G M N T UCode        (IdCode u' u'' u''') UCode ()
    rEV G M N T (FunEl g)    (IdCode u' u'' u''') UCode ()
    rEV G M N T (PiCode b f) (IdCode u' u'' u''') UCode ()
    rEV G M N T (RefEl w)    (IdCode u' u'' u''') UCode ()
    -- a = IdCode type: restrict the proof value
    rEV G M N T u Bot            (IdCode a a1 a2) le mem fmu src = tt
    rEV G M N T u UCode          (IdCode a a1 a2) le mem fmu src = tt
    rEV G M N T u (FunEl h)      (IdCode a a1 a2) le mem fmu src = tt
    rEV G M N T u (PiCode b f)   (IdCode a a1 a2) le mem fmu src = tt
    rEV G M N T u (IdCode s0 s1 s2) (IdCode a a1 a2) le mem fmu src = tt
    rEV G M N T (RefEl w) (RefEl w') (IdCode a a1 a2) le mem fmu src =
      let ridM = fst (snd src) ; ridN = fst (snd (snd src)) ; reid = snd (snd (snd src))
          fm_w' = finMem-ref-wit w' a a1 a2 mem
          fm_w  = finMem-ref-wit w a a1 a2 fmu
      in mkSigma (fst src)
        (mkSigma (record
          ...
          ; red = RValId.red ridM ; wit0 = RValId.wit0 ridM ; redTm = RValId.redTm ridM ; refConvL = RValId.refConvL ridM ; refConvR = RValId.refConvR ridM
          ; refMem = mem
          ; endEqL = ihrEV G (RValId.wit0 ridM) (RValId.lhs0 ridM) (RValId.domA0 ridM) w w' a le fm_w' fm_w (RValId.endEqL ridM)
          ; endEqR = ihrEV G (RValId.wit0 ridM) (RValId.rhs0 ridM) (RValId.domA0 ridM) w w' a le fm_w' fm_w (RValId.endEqR ridM) })
          (mkSigma (record
            { domA0 = RValId.domA0 ridN ; lhs0 = RValId.lhs0 ridN ; rhs0 = RValId.rhs0 ridN
            ; red = RValId.red ridN ; wit0 = RValId.wit0 ridN ; redTm = RValId.redTm ridN ; refConvL = RValId.refConvL ridN ; refConvR = RValId.refConvR ridN
            ; refMem = mem
            ; endEqL = ihrEV G (RValId.wit0 ridN) (RValId.lhs0 ridN) (RValId.domA0 ridN) w w' a le fm_w' fm_w (RValId.endEqL ridN)
            ; endEqR = ihrEV G (RValId.wit0 ridN) (RValId.rhs0 ridN) (RValId.domA0 ridN) w w' a le fm_w' fm_w (RValId.endEqR ridN) })
            (record
              { domA0 = REqValId.domA0 reid ; lhs0 = REqValId.lhs0 reid ; rhs0 = REqValId.rhs0 reid
              ; red = REqValId.red reid ; wit0M = REqValId.wit0M reid ; wit0N = REqValId.wit0N reid ; redTmM = REqValId.redTmM reid ; redTmN = REqValId.redTmN reid
              ; refMem = mem
              ; endEqLM = ihrEV G (REqValId.wit0M reid) (REqValId.lhs0 reid) (REqValId.domA0 reid) w w' a le fm_w' fm_w (REqValId.endEqLM reid)
              ; endEqRM = ihrEV G (REqValId.wit0M reid) (REqValId.rhs0 reid) (REqValId.domA0 reid) w w' a le fm_w' fm_w (REqValId.endEqRM reid)
              ; endEqLN = ihrEV G (REqValId.wit0N reid) (REqValId.lhs0 reid) (REqValId.domA0 reid) w w' a le fm_w' fm_w (REqValId.endEqLN reid)
              ; endEqRN = ihrEV G (REqValId.wit0N reid) (REqValId.rhs0 reid) (REqValId.domA0 reid) w w' a le fm_w' fm_w (REqValId.endEqRN reid) })))
    rEV G M N T Bot          (RefEl w') (IdCode a a1 a2) ()
    rEV G M N T UCode        (RefEl w') (IdCode a a1 a2) ()
    rEV G M N T (FunEl g)    (RefEl w') (IdCode a a1 a2) ()
    rEV G M N T (PiCode b f) (RefEl w') (IdCode a a1 a2) ()
    rEV G M N T (IdCode s0 s1 s2) (RefEl w') (IdCode a a1 a2) ()
    ...
    vfe1 (IdCode u u1 u2) UCode ev = mkSigma (fst ev) (fst (snd ev))
    vfe1 (RefEl u) UCode ev = tt
    vfe1 (IdCode u u1 u2) (FunEl h) ev = tt
    vfe1 (RefEl u) (FunEl h) ev = tt
    vfe1 (IdCode u u1 u2) (PiCode b f) ev = tt
    vfe1 (RefEl u) (PiCode b f) ev = tt
    vfe1 Bot (IdCode a a1 a2) ev = tt
    vfe1 UCode (IdCode a a1 a2) ev = tt
    vfe1 (FunEl g) (IdCode a a1 a2) ev = tt
    vfe1 (PiCode b f) (IdCode a a1 a2) ev = tt
    vfe1 (IdCode s0 s1 s2) (IdCode a a1 a2) ev = tt
    vfe1 (RefEl w) (IdCode a a1 a2) ev = mkSigma (fst ev) (fst (snd ev))
    vfe1 u (RefEl a) ev = tt
    ...
    vfe2 (IdCode u u1 u2) UCode ev = mkSigma (fst ev) (fst (snd (snd ev)))
    vfe2 (RefEl u) UCode ev = tt
    vfe2 (IdCode u u1 u2) (FunEl h) ev = tt
    vfe2 (RefEl u) (FunEl h) ev = tt
    vfe2 (IdCode u u1 u2) (PiCode b f) ev = tt
    vfe2 (RefEl u) (PiCode b f) ev = tt
    vfe2 Bot (IdCode a a1 a2) ev = tt
    vfe2 UCode (IdCode a a1 a2) ev = tt
    vfe2 (FunEl g) (IdCode a a1 a2) ev = tt
    vfe2 (PiCode b f) (IdCode a a1 a2) ev = tt
    vfe2 (IdCode s0 s1 s2) (IdCode a a1 a2) ev = tt
    vfe2 (RefEl w) (IdCode a a1 a2) ev = mkSigma (fst ev) (fst (snd (snd ev)))
    vfe2 u (RefEl a) ev = tt
