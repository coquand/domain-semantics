...
------------------------------------------------------------------------
module ID.Domain.RankSandwich where
...
open import ID.Domain.MemUnfold using ( finMemC-bot-to ; finMemC-bot-from ; FinMem-coh-u )
open import ID.Domain.Membership
  using ( finMem-piU-dom ; finMem-piU-allU ; finMem-piU-cft
        ; finMem-funel-fun ; finMem-funel-wf )
open import ID.Domain.RankSandwichCore using ( SStmt ; SOut )
open import ID.Domain.RankSandwichFam using ( typeShrink )
open import ID.Domain.RankSandwichFunBuild using ( funShrink )
