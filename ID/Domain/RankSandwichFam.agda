...
------------------------------------------------------------------------
module ID.Domain.RankSandwichFam where
...
open import ID.Domain.MemProps using ( finMem-upward )
open import ID.Domain.Basic using ( UCode )
...
------------------------------------------------------------------------
open import ID.Domain.Basic using ( Eq ; Eq-sym ; Eq-transport )
open import ID.Domain.Order
...
open import ID.Domain.MemProps using ( FinMem-Sup-element ; FinMemAllU-append-Sup )
open import ID.Domain.MemUnfold using ( FinMem-coh-u ; FinMem-coh-a )
open import ID.Domain.Membership using ( allU-to ; allU-from )
open import ID.Domain.RankSandwichCore using ( SStmt ; SOut ; edgeCore ; EdgeOut )
open import ID.Domain.FamU using ( FamToU ; build-h2 ; piU-intro )
...
------------------------------------------------------------------------
open import ID.Domain.FamU using ( mkFamToU )
open import ID.Domain.Basic using ( PiCode )
