...
module ID.Domain.OrderProps where
...
mutual
  ...
  -- Id fragment
  lei-sound zero    UCode        (IdCode _ _ _) ()
  lei-sound zero    UCode        (RefEl _)     ()
  lei-sound zero    (FunEl _)    (IdCode _ _ _) ()
  lei-sound zero    (FunEl _)    (RefEl _)     ()
  lei-sound zero    (PiCode _ _) (IdCode _ _ _) ()
  lei-sound zero    (PiCode _ _) (RefEl _)     ()
  lei-sound zero    (IdCode _ _ _) _           ()
  lei-sound zero    (RefEl _)    _             ()
  lei-sound (suc n) UCode        (IdCode _ _ _) ()
  lei-sound (suc n) UCode        (RefEl _)     ()
  lei-sound (suc n) (FunEl _)    (IdCode _ _ _) ()
  lei-sound (suc n) (FunEl _)    (RefEl _)     ()
  lei-sound (suc n) (PiCode _ _) (IdCode _ _ _) ()
  lei-sound (suc n) (PiCode _ _) (RefEl _)     ()
  lei-sound (suc n) (IdCode _ _ _) Bot          ()
  lei-sound (suc n) (IdCode _ _ _) UCode        ()
  lei-sound (suc n) (IdCode _ _ _) (FunEl _)    ()
  lei-sound (suc n) (IdCode _ _ _) (PiCode _ _) ()
  lei-sound (suc n) (IdCode _ _ _) (RefEl _)    ()
  lei-sound (suc n) (IdCode t u v) (IdCode t' u' v') p =
    let pp = min-isPos (OB.lei n t t') (min (OB.lei n u u') (OB.lei n v v')) p
        pq = min-isPos (OB.lei n u u') (OB.lei n v v') (snd pp)
    in mkSigma (lei-sound n t t' (fst pp))
               (mkSigma (lei-sound n u u' (fst pq)) (lei-sound n v v' (snd pq)))
  lei-sound (suc n) (RefEl _)    Bot          ()
  lei-sound (suc n) (RefEl _)    UCode        ()
  lei-sound (suc n) (RefEl _)    (FunEl _)    ()
  lei-sound (suc n) (RefEl _)    (PiCode _ _) ()
  lei-sound (suc n) (RefEl _)    (IdCode _ _ _) ()
  lei-sound (suc n) (RefEl w)    (RefEl w')   p = lei-sound n w w' p
...
mutual
  ...
  -- Id fragment
  lei-complete zero    UCode        (IdCode _ _ _) ()
  lei-complete zero    UCode        (RefEl _)     ()
  lei-complete zero    (FunEl _)    (IdCode _ _ _) ()
  lei-complete zero    (FunEl _)    (RefEl _)     ()
  lei-complete zero    (PiCode _ _) (IdCode _ _ _) ()
  lei-complete zero    (PiCode _ _) (RefEl _)     ()
  lei-complete zero    (IdCode _ _ _) _           ()
  lei-complete zero    (RefEl _)    _             ()
  lei-complete (suc n) UCode        (IdCode _ _ _) ()
  lei-complete (suc n) UCode        (RefEl _)     ()
  lei-complete (suc n) (FunEl _)    (IdCode _ _ _) ()
  lei-complete (suc n) (FunEl _)    (RefEl _)     ()
  lei-complete (suc n) (PiCode _ _) (IdCode _ _ _) ()
  lei-complete (suc n) (PiCode _ _) (RefEl _)     ()
  lei-complete (suc n) (IdCode _ _ _) Bot          ()
  lei-complete (suc n) (IdCode _ _ _) UCode        ()
  lei-complete (suc n) (IdCode _ _ _) (FunEl _)    ()
  lei-complete (suc n) (IdCode _ _ _) (PiCode _ _) ()
  lei-complete (suc n) (IdCode _ _ _) (RefEl _)    ()
  lei-complete (suc n) (IdCode t u v) (IdCode t' u' v') p =
    isPos-min (OB.lei n t t') (min (OB.lei n u u') (OB.lei n v v'))
      (lei-complete n t t' (fst p))
      (isPos-min (OB.lei n u u') (OB.lei n v v')
        (lei-complete n u u' (fst (snd p)))
        (lei-complete n v v' (snd (snd p))))
  lei-complete (suc n) (RefEl _)    Bot          ()
  lei-complete (suc n) (RefEl _)    UCode        ()
  lei-complete (suc n) (RefEl _)    (FunEl _)    ()
  lei-complete (suc n) (RefEl _)    (PiCode _ _) ()
  lei-complete (suc n) (RefEl _)    (IdCode _ _ _) ()
  lei-complete (suc n) (RefEl w)    (RefEl w')   p = lei-complete n w w' p
...
-- Id fragment: cross-constructor Sups are Bot; diagonals recurse.
leq-Sup-lub n UCode        (IdCode _ _ _) c ac bc = leq-Bot-any n c
leq-Sup-lub n UCode        (RefEl _)      c ac bc = leq-Bot-any n c
leq-Sup-lub n (FunEl g)    (IdCode _ _ _) c ac bc = leq-Bot-any n c
leq-Sup-lub n (FunEl g)    (RefEl _)      c ac bc = leq-Bot-any n c
leq-Sup-lub n (PiCode a f) (IdCode _ _ _) c ac bc = leq-Bot-any n c
leq-Sup-lub n (PiCode a f) (RefEl _)      c ac bc = leq-Bot-any n c
leq-Sup-lub n (IdCode t u v) Bot          c ac bc = ac
leq-Sup-lub n (IdCode t u v) UCode        c ac bc = leq-Bot-any n c
leq-Sup-lub n (IdCode t u v) (FunEl _)    c ac bc = leq-Bot-any n c
leq-Sup-lub n (IdCode t u v) (PiCode _ _) c ac bc = leq-Bot-any n c
leq-Sup-lub n (IdCode t u v) (RefEl _)    c ac bc = leq-Bot-any n c
leq-Sup-lub zero    (IdCode t u v) (IdCode t' u' v') c            () bc
leq-Sup-lub (suc n) (IdCode t u v) (IdCode t' u' v') Bot          () bc
leq-Sup-lub (suc n) (IdCode t u v) (IdCode t' u' v') UCode        () bc
leq-Sup-lub (suc n) (IdCode t u v) (IdCode t' u' v') (FunEl _)    () bc
leq-Sup-lub (suc n) (IdCode t u v) (IdCode t' u' v') (PiCode _ _) () bc
leq-Sup-lub (suc n) (IdCode t u v) (IdCode t' u' v') (RefEl _)    () bc
leq-Sup-lub (suc n) (IdCode t u v) (IdCode t' u' v') (IdCode c1 c2 c3) ac bc =
  mkSigma (leq-Sup-lub n t t' c1 (fst ac) (fst bc))
          (mkSigma (leq-Sup-lub n u u' c2 (fst (snd ac)) (fst (snd bc)))
                   (leq-Sup-lub n v v' c3 (snd (snd ac)) (snd (snd bc))))
leq-Sup-lub n (RefEl w)    Bot          c ac bc = ac
leq-Sup-lub n (RefEl w)    UCode        c ac bc = leq-Bot-any n c
leq-Sup-lub n (RefEl w)    (FunEl _)    c ac bc = leq-Bot-any n c
leq-Sup-lub n (RefEl w)    (PiCode _ _) c ac bc = leq-Bot-any n c
leq-Sup-lub n (RefEl w)    (IdCode _ _ _) c ac bc = leq-Bot-any n c
leq-Sup-lub zero    (RefEl w) (RefEl w') c            () bc
leq-Sup-lub (suc n) (RefEl w) (RefEl w') Bot          () bc
leq-Sup-lub (suc n) (RefEl w) (RefEl w') UCode        () bc
leq-Sup-lub (suc n) (RefEl w) (RefEl w') (FunEl _)    () bc
leq-Sup-lub (suc n) (RefEl w) (RefEl w') (PiCode _ _) () bc
leq-Sup-lub (suc n) (RefEl w) (RefEl w') (IdCode _ _ _) () bc
leq-Sup-lub (suc n) (RefEl w) (RefEl w') (RefEl c1)   ac bc =
  leq-Sup-lub n w w' c1 ac bc
