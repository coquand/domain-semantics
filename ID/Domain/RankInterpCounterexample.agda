...
------------------------------------------------------------------------
module ID.Domain.RankInterpCounterexample where
...
open import ID.Domain.Order using ( RANK ; LeCode ; Coherent ; CoherentFunTail ; mkCFT )
open import ID.Domain.MemStage using ( finMemC )
open import ID.Domain.Order using ( EvalFun ; EvalFun-step ; leFinEl ; leFinEl-sound )
open import ID.Domain.Basic using ( isPos )
...
open import ID.Domain.Basic using ( Le-trans ; Le-max-r ; Eq )
...
open import ID.Domain.KeyJoinLemma using ( sel-rank )
