...
module ID.Domain.OrderProps2 where
...
open import ID.Domain.OrderProps
  ...
  Comp-down-n (suc m) (PiCode a f) (PiCode b g) (PiCode c2 k) cu cu' le comp =
    mkSigma
      ...
      (LeFunCode-CompFun-trans-n m f g k
        ...
        (snd le) (snd comp))
  -- Id fragment
  Comp-down-n zero (IdCode _ _ _) u' v () cu' le c
  Comp-down-n zero (RefEl _)      u' v () cu' le c
  Comp-down-n (suc m) (IdCode _ _ _) Bot          v cu cu' () c
  Comp-down-n (suc m) (IdCode _ _ _) UCode        v cu cu' () c
  Comp-down-n (suc m) (IdCode _ _ _) (FunEl _)    v cu cu' () c
  Comp-down-n (suc m) (IdCode _ _ _) (PiCode _ _) v cu cu' () c
  Comp-down-n (suc m) (IdCode _ _ _) (RefEl _)    v cu cu' () c
  Comp-down-n (suc m) (IdCode t u v) (IdCode t' u' v') Bot          cu cu' le c = tt
  Comp-down-n (suc m) (IdCode t u v) (IdCode t' u' v') UCode        cu cu' le ()
  Comp-down-n (suc m) (IdCode t u v) (IdCode t' u' v') (FunEl _)    cu cu' le ()
  Comp-down-n (suc m) (IdCode t u v) (IdCode t' u' v') (PiCode _ _) cu cu' le ()
  Comp-down-n (suc m) (IdCode t u v) (IdCode t' u' v') (RefEl _)    cu cu' le ()
  Comp-down-n (suc m) (IdCode t u v) (IdCode t' u' v') (IdCode t2 u2 v2) cu cu' le c =
    let ruv  = max-Le-r (RANK t) (max (RANK u) (RANK v)) m cu
        ruv' = max-Le-r (RANK t') (max (RANK u') (RANK v')) m cu'
    in mkSigma
         (Comp-down-n m t t' t2 (max-Le-l (RANK t) (max (RANK u) (RANK v)) m cu)
           (max-Le-l (RANK t') (max (RANK u') (RANK v')) m cu') (fst le) (fst c))
         (mkSigma
           (Comp-down-n m u u' u2 (max-Le-l (RANK u) (RANK v) m ruv)
             (max-Le-l (RANK u') (RANK v') m ruv') (fst (snd le)) (fst (snd c)))
           (Comp-down-n m v v' v2 (max-Le-r (RANK u) (RANK v) m ruv)
             (max-Le-r (RANK u') (RANK v') m ruv') (snd (snd le)) (snd (snd c))))
  Comp-down-n (suc m) (RefEl _) Bot          v cu cu' () c
  Comp-down-n (suc m) (RefEl _) UCode        v cu cu' () c
  Comp-down-n (suc m) (RefEl _) (FunEl _)    v cu cu' () c
  Comp-down-n (suc m) (RefEl _) (PiCode _ _) v cu cu' () c
  Comp-down-n (suc m) (RefEl _) (IdCode _ _ _) v cu cu' () c
  Comp-down-n (suc m) (RefEl w) (RefEl w') Bot          cu cu' le c = tt
  Comp-down-n (suc m) (RefEl w) (RefEl w') UCode        cu cu' le ()
  Comp-down-n (suc m) (RefEl w) (RefEl w') (FunEl _)    cu cu' le ()
  Comp-down-n (suc m) (RefEl w) (RefEl w') (PiCode _ _) cu cu' le ()
  Comp-down-n (suc m) (RefEl w) (RefEl w') (IdCode _ _ _) cu cu' le ()
  Comp-down-n (suc m) (RefEl w) (RefEl w') (RefEl w2)    cu cu' le c =
    Comp-down-n m w w' w2 cu cu' le c
...
mutual
  ...
  LeCode-refl-n zero    (IdCode _ _ _) () ca
  LeCode-refl-n zero    (RefEl _)      () ca
  LeCode-refl-n (suc m) (IdCode t u v) cond ca =
    let ruv = max-Le-r (RANK t) (max (RANK u) (RANK v)) m cond
    in mkSigma (LeCode-refl-n m t (max-Le-l (RANK t) (max (RANK u) (RANK v)) m cond) (fst ca))
               (mkSigma (LeCode-refl-n m u (max-Le-l (RANK u) (RANK v) m ruv) (fst (snd ca)))
                        (LeCode-refl-n m v (max-Le-r (RANK u) (RANK v) m ruv) (snd (snd ca))))
  LeCode-refl-n (suc m) (RefEl w) cond ca = LeCode-refl-n m w cond ca
  ...
  -- Id fragment
  LeCode-Sup-left-n n UCode (IdCode _ _ _) ba bb () ca cb
  LeCode-Sup-left-n n UCode (RefEl _)      ba bb () ca cb
  LeCode-Sup-left-n (suc m) (FunEl g) (IdCode _ _ _) ba bb () ca cb
  LeCode-Sup-left-n (suc m) (FunEl g) (RefEl _)      ba bb () ca cb
  LeCode-Sup-left-n (suc m) (PiCode a f) (IdCode _ _ _) ba bb () ca cb
  LeCode-Sup-left-n (suc m) (PiCode a f) (RefEl _)      ba bb () ca cb
  LeCode-Sup-left-n zero (IdCode _ _ _) b () bb comp ca cb
  LeCode-Sup-left-n (suc m) (IdCode t u v) Bot ba bb comp ca cb =
    LeCode-refl-n (suc m) (IdCode t u v) ba ca
  LeCode-Sup-left-n (suc m) (IdCode t u v) UCode ba bb () ca cb
  LeCode-Sup-left-n (suc m) (IdCode t u v) (FunEl _) ba bb () ca cb
  LeCode-Sup-left-n (suc m) (IdCode t u v) (PiCode _ _) ba bb () ca cb
  LeCode-Sup-left-n (suc m) (IdCode t u v) (RefEl _) ba bb () ca cb
  LeCode-Sup-left-n (suc m) (IdCode t u v) (IdCode t1 u1 v1) ba bb comp ca cb =
    let ruv  = max-Le-r (RANK t) (max (RANK u) (RANK v)) m ba
        ruv1 = max-Le-r (RANK t1) (max (RANK u1) (RANK v1)) m bb
    in mkSigma
         (LeCode-Sup-left-n m t t1 (max-Le-l (RANK t) (max (RANK u) (RANK v)) m ba)
           (max-Le-l (RANK t1) (max (RANK u1) (RANK v1)) m bb) (fst comp) (fst ca) (fst cb))
         (mkSigma
           (LeCode-Sup-left-n m u u1 (max-Le-l (RANK u) (RANK v) m ruv)
             (max-Le-l (RANK u1) (RANK v1) m ruv1) (fst (snd comp)) (fst (snd ca)) (fst (snd cb)))
           (LeCode-Sup-left-n m v v1 (max-Le-r (RANK u) (RANK v) m ruv)
             (max-Le-r (RANK u1) (RANK v1) m ruv1) (snd (snd comp)) (snd (snd ca)) (snd (snd cb))))
  LeCode-Sup-left-n zero (RefEl _) b () bb comp ca cb
  LeCode-Sup-left-n (suc m) (RefEl w) Bot ba bb comp ca cb =
    LeCode-refl-n (suc m) (RefEl w) ba ca
  LeCode-Sup-left-n (suc m) (RefEl w) UCode ba bb () ca cb
  LeCode-Sup-left-n (suc m) (RefEl w) (FunEl _) ba bb () ca cb
  LeCode-Sup-left-n (suc m) (RefEl w) (PiCode _ _) ba bb () ca cb
  LeCode-Sup-left-n (suc m) (RefEl w) (IdCode _ _ _) ba bb () ca cb
  LeCode-Sup-left-n (suc m) (RefEl w) (RefEl w1) ba bb comp ca cb =
    LeCode-Sup-left-n m w w1 ba bb comp ca cb
  ...
  LeCode-Sup-right-n (suc m) (PiCode a f) (PiCode d h) ba bb comp ca cb =
    mkSigma
      ...
      (LeFunCode-append-right-n m f h
        ...
        (snd comp) (snd ca) (snd cb))
  -- Id fragment
  LeCode-Sup-right-n zero a (IdCode _ _ _) ba () comp ca cb
  LeCode-Sup-right-n zero a (RefEl _)      ba () comp ca cb
  LeCode-Sup-right-n n (IdCode _ _ _) UCode ba bb () ca cb
  LeCode-Sup-right-n n (RefEl _)      UCode ba bb () ca cb
  LeCode-Sup-right-n (suc m) (IdCode _ _ _) (FunEl _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (RefEl _)      (FunEl _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (IdCode _ _ _) (PiCode _ _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (RefEl _)      (PiCode _ _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) Bot (IdCode t u v) ba bb comp ca cb =
    LeCode-refl-n (suc m) (IdCode t u v) bb cb
  LeCode-Sup-right-n (suc m) UCode (IdCode _ _ _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (FunEl g) (IdCode _ _ _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (PiCode a f) (IdCode _ _ _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (RefEl _) (IdCode _ _ _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (IdCode t1 u1 v1) (IdCode t u v) ba bb comp ca cb =
    let ruv1 = max-Le-r (RANK t1) (max (RANK u1) (RANK v1)) m ba
        ruv  = max-Le-r (RANK t) (max (RANK u) (RANK v)) m bb
    in mkSigma
         (LeCode-Sup-right-n m t1 t (max-Le-l (RANK t1) (max (RANK u1) (RANK v1)) m ba)
           (max-Le-l (RANK t) (max (RANK u) (RANK v)) m bb) (fst comp) (fst ca) (fst cb))
         (mkSigma
           (LeCode-Sup-right-n m u1 u (max-Le-l (RANK u1) (RANK v1) m ruv1)
             (max-Le-l (RANK u) (RANK v) m ruv) (fst (snd comp)) (fst (snd ca)) (fst (snd cb)))
           (LeCode-Sup-right-n m v1 v (max-Le-r (RANK u1) (RANK v1) m ruv1)
             (max-Le-r (RANK u) (RANK v) m ruv) (snd (snd comp)) (snd (snd ca)) (snd (snd cb))))
  LeCode-Sup-right-n (suc m) Bot (RefEl w) ba bb comp ca cb =
    LeCode-refl-n (suc m) (RefEl w) bb cb
  LeCode-Sup-right-n (suc m) UCode (RefEl _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (FunEl g) (RefEl _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (PiCode a f) (RefEl _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (IdCode _ _ _) (RefEl _) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (RefEl w1) (RefEl w) ba bb comp ca cb =
    LeCode-Sup-right-n m w1 w ba bb comp ca cb
  ...
  -- Id fragment
  LeCode-trans-n zero    UCode (IdCode _ _ _) z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) UCode (IdCode _ _ _) z bx by bz cx cy cz () yz
  LeCode-trans-n zero    UCode (RefEl _)      z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) UCode (RefEl _)      z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (FunEl g) (IdCode _ _ _) z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (FunEl g) (RefEl _)      z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (FunEl g) (FunEl h) (IdCode _ _ _) bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (FunEl g) (FunEl h) (RefEl _)      bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (PiCode a f) (IdCode _ _ _) z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (PiCode a f) (RefEl _)      z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (PiCode a f) (PiCode b g) (IdCode _ _ _) bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (PiCode a f) (PiCode b g) (RefEl _)      bx by bz cx cy cz xy ()
  LeCode-trans-n zero (IdCode _ _ _) y z () by bz cx cy cz xy yz
  LeCode-trans-n (suc m) (IdCode _ _ _) Bot          z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (IdCode _ _ _) UCode        z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (IdCode _ _ _) (FunEl _)    z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (IdCode _ _ _) (PiCode _ _) z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (IdCode _ _ _) (RefEl _)    z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (IdCode t u v) (IdCode t' u' v') Bot          bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (IdCode t u v) (IdCode t' u' v') UCode        bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (IdCode t u v) (IdCode t' u' v') (FunEl _)    bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (IdCode t u v) (IdCode t' u' v') (PiCode _ _) bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (IdCode t u v) (IdCode t' u' v') (RefEl _)    bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (IdCode t u v) (IdCode t' u' v') (IdCode t'' u'' v'') bx by bz cx cy cz xy yz =
    let ruv   = max-Le-r (RANK t) (max (RANK u) (RANK v)) m bx
        ruv'  = max-Le-r (RANK t') (max (RANK u') (RANK v')) m by
        ruv'' = max-Le-r (RANK t'') (max (RANK u'') (RANK v'')) m bz
    in mkSigma
         (LeCode-trans-n m t t' t'' (max-Le-l (RANK t) (max (RANK u) (RANK v)) m bx)
           (max-Le-l (RANK t') (max (RANK u') (RANK v')) m by)
           (max-Le-l (RANK t'') (max (RANK u'') (RANK v'')) m bz)
           (fst cx) (fst cy) (fst cz) (fst xy) (fst yz))
         (mkSigma
           (LeCode-trans-n m u u' u'' (max-Le-l (RANK u) (RANK v) m ruv)
             (max-Le-l (RANK u') (RANK v') m ruv') (max-Le-l (RANK u'') (RANK v'') m ruv'')
             (fst (snd cx)) (fst (snd cy)) (fst (snd cz)) (fst (snd xy)) (fst (snd yz)))
           (LeCode-trans-n m v v' v'' (max-Le-r (RANK u) (RANK v) m ruv)
             (max-Le-r (RANK u') (RANK v') m ruv') (max-Le-r (RANK u'') (RANK v'') m ruv'')
             (snd (snd cx)) (snd (snd cy)) (snd (snd cz)) (snd (snd xy)) (snd (snd yz))))
  LeCode-trans-n zero (RefEl _) y z () by bz cx cy cz xy yz
  LeCode-trans-n (suc m) (RefEl _) Bot          z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (RefEl _) UCode        z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (RefEl _) (FunEl _)    z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (RefEl _) (PiCode _ _) z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (RefEl _) (IdCode _ _ _) z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (RefEl w) (RefEl w') Bot          bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (RefEl w) (RefEl w') UCode        bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (RefEl w) (RefEl w') (FunEl _)    bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (RefEl w) (RefEl w') (PiCode _ _) bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (RefEl w) (RefEl w') (IdCode _ _ _) bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (RefEl w) (RefEl w') (RefEl w'') bx by bz cx cy cz xy yz =
    LeCode-trans-n m w w' w'' bx by bz cx cy cz xy yz
