...
------------------------------------------------------------------------
module ID.Domain.RankSandwichCore where
...
open import ID.Domain.Membership using ( FinMemAllU ; allU-to )
open import ID.Domain.MemProps using ( finMem-upward ; EvalFun-in-UCode )
open import ID.Domain.MemUnfold using ( FinMem-coh-u ; FinMem-a-in-U ; FinMem-coh-a )
open import ID.Domain.KeyJoinLemma using ( keyJoinLemma ; typedKeyJoin )
open import ID.Domain.Order using ( Le-max-lub )
