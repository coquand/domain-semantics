...
module ID.Adequacy.AppInj where

open import ID.Adequacy.HeadRed

import ID.Domain.Basic as S
open S using (Nat ; zero ; suc ; Top ; tt ; Empty ; Sigma ; mkSigma ; fst ; snd ; Pair ; Eq ; FinEl ; Bot ; UCode ; FunEl ; PiCode ; IdCode ; RefEl ; FinFun ; List ; nil ; cons)
...
open import ID.Adequacy.App using (AdSub2Rec ; AdConvSub2Rec ; app-transport-EqVal2)
open import ID.Adequacy.Pi using (Val2-U-to-ValTy2)
...
adequacyV-ty-App-inj {H = H} {A = A} {B = B} {f = f0} {a = a} dA dB df da adSub2 sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH funcross argsingle argcross (FunEl gfe) hu (PiCode bacfe facfe) evA fm =
  adequacyConvSub2-App-core-body-inj {H = H} {A = A} {B = B} {f = f0} {a = a}
    ...
    adSub2 funcross argsingle argcross Val2-U-to-ValTy2 app-transport-EqVal2
adequacyV-ty-App-inj {H = H} {A = A} {B = B} {f = f0} {a = a} dA dB df da adSub2 sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH funcross argsingle argcross (IdCode ib ic idd) hu UCode evA fm =
  adequacyConvSub2-App-core-body-inj {H = H} {A = A} {B = B} {f = f0} {a = a}
    dA dB df da sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH
    (IdCode ib ic idd) (fst hu) (fst (snd hu)) (snd (snd hu)) UCode evA fm
    adSub2 funcross argsingle argcross Val2-U-to-ValTy2 app-transport-EqVal2
adequacyV-ty-App-inj {H = H} {A = A} {B = B} {f = f0} {a = a} dA dB df da adSub2 sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH funcross argsingle argcross (RefEl rw) hu (IdCode ac ac1 ac2) evA fm =
  adequacyConvSub2-App-core-body-inj {H = H} {A = A} {B = B} {f = f0} {a = a}
    dA dB df da sigma sigma' rho crho vs vs' vcs fits wtsub wtsub' wcs wfH
