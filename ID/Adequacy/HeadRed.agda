...
-- head-expansion family (ID.Validity.HeadRed).
--
...
module ID.Adequacy.HeadRed where
open import ID.Adequacy.Helpers public
open import ID.Validity.HeadRed public
  using (Val2-headred-contract ; EqVal2-headred-contract ; EqVal2-headred-expand)

open import ID.Domain.Basic using (Nat ; FinEl)
