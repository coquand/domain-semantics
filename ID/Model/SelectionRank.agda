...
module ID.Model.SelectionRank where

open import ID.Domain.Basic
  using (FinEl ; Bot ; FinFun ; nil ; cons ; fst ; snd ; tt ; max ;
         Le ; Le-trans ; Le-max-l ; Le-max-r)
open import ID.Domain.Kernel using (Sup)
open import ID.Model.Selection using (Selection ; sel-nil ; sel-skip ; sel-take ; Edge)
open import ID.Domain.Rank using (RANK ; RANKFun ; RANK-Sup ; Le-max-lub)
