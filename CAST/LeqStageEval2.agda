...
module CAST.LeqStageEval2 where
...
open import CAST.LeqStageStable using ( leiC-sound )
open import CAST.LeqStageBridge
  using ( EvalFun ; EvalFun-step ; LeCode ; LeFunCode ; LeqC-to-LeCode )
open import CAST.LeqStageInterface using ( Comp-value-EvalFun )
