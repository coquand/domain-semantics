...
module CAST.LeqStageProps where
...
mutual
  ...
  lei-sound zero    (PiCode _ _) (IdCode _ _)  ()
  lei-sound zero    (IdCode _ _) v             ()
  -- Stage (suc n)
  ...
  lei-sound (suc n) UCode        (IdCode _ _)  ()
  ...
  lei-sound (suc n) (FunEl _)    (IdCode _ _)  ()
  ...
  lei-sound (suc n) (PiCode _ _) (IdCode _ _)  ()
  lei-sound (suc n) (IdCode _ _) Bot           ()
  lei-sound (suc n) (IdCode _ _) UCode         ()
  lei-sound (suc n) (IdCode _ _) (FunEl _)     ()
  lei-sound (suc n) (IdCode _ _) (PiCode _ _)  ()
  lei-sound (suc n) (IdCode a b) (IdCode c d)  p =
    let pp = min-isPos (OB.lei n a c) (OB.lei n b d) p
    in mkSigma (lei-sound n a c (fst pp)) (lei-sound n b d (snd pp))
...
mutual
  ...
  lei-complete zero    UCode        (IdCode _ _)  ()
  ...
  lei-complete zero    (FunEl _)    (IdCode _ _)  ()
  ...
  lei-complete zero    (PiCode _ _) (IdCode _ _)  ()
  lei-complete zero    (IdCode _ _) v             ()
  ...
  lei-complete (suc n) UCode        (IdCode _ _)  ()
  ...
  lei-complete (suc n) (FunEl _)    (IdCode _ _)  ()
  ...
  lei-complete (suc n) (PiCode _ _) (IdCode _ _)  ()
  lei-complete (suc n) (IdCode _ _) Bot           ()
  lei-complete (suc n) (IdCode _ _) UCode         ()
  lei-complete (suc n) (IdCode _ _) (FunEl _)     ()
  lei-complete (suc n) (IdCode _ _) (PiCode _ _)  ()
  lei-complete (suc n) (IdCode a b) (IdCode c d)  p =
    isPos-min (OB.lei n a c) (OB.lei n b d)
      (lei-complete n a c (fst p)) (lei-complete n b d (snd p))
...
leq-Sup-lub n UCode        (IdCode _ _) c ac bc = leq-Bot-any n c
...
leq-Sup-lub (suc n) (FunEl g) (FunEl h) (IdCode _ _) () bc
leq-Sup-lub n (FunEl g)    (PiCode _ _) c ac bc = leq-Bot-any n c
leq-Sup-lub n (FunEl g)    (IdCode _ _) c ac bc = leq-Bot-any n c
...
leq-Sup-lub (suc n) (PiCode a f) (PiCode b g) (IdCode _ _) ac ()
leq-Sup-lub n (PiCode a f) (IdCode _ _) c ac bc = leq-Bot-any n c
leq-Sup-lub n (IdCode a b) Bot          c ac bc = ac
leq-Sup-lub n (IdCode a b) UCode        c ac bc = leq-Bot-any n c
leq-Sup-lub n (IdCode a b) (FunEl _)    c ac bc = leq-Bot-any n c
leq-Sup-lub n (IdCode a b) (PiCode _ _) c ac bc = leq-Bot-any n c
leq-Sup-lub zero    (IdCode a b) (IdCode c d) e            () bc
leq-Sup-lub (suc n) (IdCode a b) (IdCode c d) Bot          () bc
leq-Sup-lub (suc n) (IdCode a b) (IdCode c d) UCode        () bc
leq-Sup-lub (suc n) (IdCode a b) (IdCode c d) (FunEl _)    () bc
leq-Sup-lub (suc n) (IdCode a b) (IdCode c d) (PiCode _ _) () bc
leq-Sup-lub (suc n) (IdCode a b) (IdCode c d) (IdCode e h) ac bc =
  mkSigma (leq-Sup-lub n a c e (fst ac) (fst bc))
          (leq-Sup-lub n b d h (snd ac) (snd bc))
