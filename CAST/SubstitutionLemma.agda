...
module CAST.SubstitutionLemma where

open import CAST.Basic using (Nat ; zero ; suc ; Eq ; refl ; Eq-cong ;
...
open import CAST.TypingRules using (Ctx ; empty ; extend ; lookup ;
  ...
  conv-cast-Pi)
open import CAST.Reduction using (idSub ; substExpr-id ; subst-subst1-comm)
...
mutual
  ...
  -- ty-Id
  ren-HasType rt wfH (ty-Id d1 d2) =
    ty-Id (ren-HasType rt wfH d1) (ren-HasType rt wfH d2)

  -- ty-refl
  ren-HasType rt wfH (ty-refl d1) = ty-refl (ren-HasType rt wfH d1)

  -- ty-sym
  ren-HasType rt wfH (ty-sym d1 d2 d3) =
    ty-sym (ren-HasType rt wfH d1) (ren-HasType rt wfH d2) (ren-HasType rt wfH d3)

  -- ty-pi1
  ren-HasType rt wfH (ty-pi1 d1 d2 d3 d4 d5) =
    let d1' = ren-HasType rt wfH d1
        d3' = ren-HasType rt wfH d3
    in ty-pi1 d1' (ren-HasType (liftRen-RenTypes rt) (wf-extend d1') d2)
              d3' (ren-HasType (liftRen-RenTypes rt) (wf-extend d3') d4)
              (ren-HasType rt wfH d5)

  -- ty-pi2 (dependent type: transport across the two subst1s)
  ren-HasType {H = H} {r = r} rt wfH (ty-pi2 {A = A} {C = C} {B = B} {D = D} {p = p} {N = N} d1 d2 d3 d4 d5 d6) =
    let d1' = ren-HasType rt wfH d1
        d3' = ren-HasType rt wfH d3
        res = ty-pi2 d1' (ren-HasType (liftRen-RenTypes rt) (wf-extend d1') d2)
                     d3' (ren-HasType (liftRen-RenTypes rt) (wf-extend d3') d4)
                     (ren-HasType rt wfH d5) (ren-HasType rt wfH d6)
    in Eq-transport (\ T -> HasType H (pi2 (renExpr r p) (renExpr r N)) T)
         (Eq-sym (Eq-cong2-Expr Id (ren-subst1 r B N)
                                   (ren-subst1 r D (cast A C (pi1 p) N))))
         res

  -- ty-cast
  ren-HasType rt wfH (ty-cast d1 d2 d3 d4) =
    ty-cast (ren-HasType rt wfH d1) (ren-HasType rt wfH d2)
            (ren-HasType rt wfH d3) (ren-HasType rt wfH d4)
  ...
  -- conv-Id
  ren-ConvTm rt wfH (conv-Id d1 d2 d3 d4 c1 c2) =
    conv-Id (ren-HasType rt wfH d1) (ren-HasType rt wfH d2)
            (ren-HasType rt wfH d3) (ren-HasType rt wfH d4)
            (ren-ConvTm rt wfH c1) (ren-ConvTm rt wfH c2)

  -- conv-cast-refl
  ren-ConvTm rt wfH (conv-cast-refl d1 d2 d3 c) =
    conv-cast-refl (ren-HasType rt wfH d1) (ren-HasType rt wfH d2)
                   (ren-HasType rt wfH d3) (ren-ConvTm rt wfH c)

  -- conv-Id-irr
  ren-ConvTm rt wfH (conv-Id-irr d1 d2) =
    conv-Id-irr (ren-HasType rt wfH d1) (ren-HasType rt wfH d2)

  -- conv-cast-cong
  ren-ConvTm rt wfH (conv-cast-cong d1 d2 d3 d4 d5 d6 d7 d8 c1 c2 c3) =
    conv-cast-cong (ren-HasType rt wfH d1) (ren-HasType rt wfH d2)
                   (ren-HasType rt wfH d3) (ren-HasType rt wfH d4)
                   (ren-HasType rt wfH d5) (ren-HasType rt wfH d6)
                   (ren-HasType rt wfH d7) (ren-HasType rt wfH d8)
                   (ren-ConvTm rt wfH c1) (ren-ConvTm rt wfH c2) (ren-ConvTm rt wfH c3)

  -- conv-pi1
  ren-ConvTm rt wfH (conv-pi1 d1 d2 d3 d4 d5 c1 c2 c3 c4 c5) =
    let d1' = ren-HasType rt wfH d1
        d3' = ren-HasType rt wfH d3
    in conv-pi1 d1' (ren-HasType (liftRen-RenTypes rt) (wf-extend d1') d2)
                d3' (ren-HasType (liftRen-RenTypes rt) (wf-extend d3') d4)
                (ren-HasType rt wfH d5)
                (ren-ConvTm rt wfH c1) (ren-ConvTm (liftRen-RenTypes rt) (wf-extend d1') c2)
                (ren-ConvTm rt wfH c3) (ren-ConvTm (liftRen-RenTypes rt) (wf-extend d3') c4)
                (ren-ConvTm rt wfH c5)

  -- conv-pi2 (transport across the two subst1s)
  ren-ConvTm {H = H} {r = r} rt wfH
    (conv-pi2 {A = A} {C = C} {B = B} {D = D} {p = p} {p' = p'} {N = N} {N' = N'} d1 d2 d3 d4 d5 d6 c1 c2 c3 c4 c5 c6) =
    let d1' = ren-HasType rt wfH d1
        d3' = ren-HasType rt wfH d3
        res = conv-pi2 d1' (ren-HasType (liftRen-RenTypes rt) (wf-extend d1') d2)
                       d3' (ren-HasType (liftRen-RenTypes rt) (wf-extend d3') d4)
                       (ren-HasType rt wfH d5) (ren-HasType rt wfH d6)
                       (ren-ConvTm rt wfH c1) (ren-ConvTm (liftRen-RenTypes rt) (wf-extend d1') c2)
                       (ren-ConvTm rt wfH c3) (ren-ConvTm (liftRen-RenTypes rt) (wf-extend d3') c4)
                       (ren-ConvTm rt wfH c5) (ren-ConvTm rt wfH c6)
    in Eq-transport (\ T -> ConvTm H (pi2 (renExpr r p) (renExpr r N))
                                     (pi2 (renExpr r p') (renExpr r N')) T)
         (Eq-sym (Eq-cong2-Expr Id (ren-subst1 r B N)
                                   (ren-subst1 r D (cast A C (pi1 p) N))))
         res

  -- conv-cast-Pi (transport across subst1 B N' and subst1 D N, in term + type)
  ren-ConvTm {H = H} {r = r} rt wfH
    (conv-cast-Pi {A = A} {C = C} {B = B} {D = D} {p = p} {M = M} {N = N} dA dB dC dD dp dM dN) =
    let dA' = ren-HasType rt wfH dA
        dC' = ren-HasType rt wfH dC
        res = conv-cast-Pi dA' (ren-HasType (liftRen-RenTypes rt) (wf-extend dA') dB)
                           dC' (ren-HasType (liftRen-RenTypes rt) (wf-extend dC') dD)
                           (ren-HasType rt wfH dp) (ren-HasType rt wfH dM) (ren-HasType rt wfH dN)
        rNpr = cast (renExpr r C) (renExpr r A) (pi1 (sym (renExpr r p))) (renExpr r N)
        rM'  = renExpr r M
        q''  = sym (pi2 (sym (renExpr r p)) (renExpr r N))
        LHS' = App (cast (Pi (renExpr r A) (renExpr (liftRen r) B))
                         (Pi (renExpr r C) (renExpr (liftRen r) D))
                         (renExpr r p) rM') (renExpr r N)
        eqB  = ren-subst1 r B (cast C A (pi1 (sym p)) N)
        eqD  = ren-subst1 r D N
        step1 = Eq-transport
                  (\ X -> ConvTm H LHS'
                            (cast X (subst1 (renExpr (liftRen r) D) (renExpr r N)) q'' (App rM' rNpr))
                            (subst1 (renExpr (liftRen r) D) (renExpr r N)))
                  (Eq-sym eqB) res
    in Eq-transport
         (\ Y -> ConvTm H LHS'
                   (cast (renExpr r (subst1 B (cast C A (pi1 (sym p)) N))) Y q'' (App rM' rNpr)) Y)
         (Eq-sym eqD) step1
  ...
  -- ty-Id
  subst-HasType ws wfH (ty-Id d1 d2) =
    ty-Id (subst-HasType ws wfH d1) (subst-HasType ws wfH d2)

  -- ty-refl
  subst-HasType ws wfH (ty-refl d1) = ty-refl (subst-HasType ws wfH d1)

  -- ty-sym
  subst-HasType ws wfH (ty-sym d1 d2 d3) =
    ty-sym (subst-HasType ws wfH d1) (subst-HasType ws wfH d2) (subst-HasType ws wfH d3)

  -- ty-pi1
  subst-HasType ws wfH (ty-pi1 d1 d2 d3 d4 d5) =
    let d1' = subst-HasType ws wfH d1
        d3' = subst-HasType ws wfH d3
    in ty-pi1 d1' (subst-HasType (liftSub-WtSub ws wfH d1) (wf-extend d1') d2)
              d3' (subst-HasType (liftSub-WtSub ws wfH d3) (wf-extend d3') d4)
              (subst-HasType ws wfH d5)

  -- ty-pi2 (transport across the two subst1s)
  subst-HasType {H = H} {sigma = sigma} ws wfH
    (ty-pi2 {A = A} {C = C} {B = B} {D = D} {p = p} {N = N} d1 d2 d3 d4 d5 d6) =
    let d1' = subst-HasType ws wfH d1
        d3' = subst-HasType ws wfH d3
        res = ty-pi2 d1' (subst-HasType (liftSub-WtSub ws wfH d1) (wf-extend d1') d2)
                     d3' (subst-HasType (liftSub-WtSub ws wfH d3) (wf-extend d3') d4)
                     (subst-HasType ws wfH d5) (subst-HasType ws wfH d6)
    in Eq-transport (\ T -> HasType H (pi2 (substExpr sigma p) (substExpr sigma N)) T)
         (Eq-cong2-Expr Id (subst-subst1-comm sigma B N)
                           (subst-subst1-comm sigma D (cast A C (pi1 p) N)))
         res

  -- ty-cast
  subst-HasType ws wfH (ty-cast d1 d2 d3 d4) =
    ty-cast (subst-HasType ws wfH d1) (subst-HasType ws wfH d2)
            (subst-HasType ws wfH d3) (subst-HasType ws wfH d4)
  ...
  -- conv-Id
  subst-ConvTm ws wfH (conv-Id d1 d2 d3 d4 c1 c2) =
    conv-Id (subst-HasType ws wfH d1) (subst-HasType ws wfH d2)
            (subst-HasType ws wfH d3) (subst-HasType ws wfH d4)
            (subst-ConvTm ws wfH c1) (subst-ConvTm ws wfH c2)

  -- conv-cast-refl
  subst-ConvTm ws wfH (conv-cast-refl d1 d2 d3 c) =
    conv-cast-refl (subst-HasType ws wfH d1) (subst-HasType ws wfH d2)
                   (subst-HasType ws wfH d3) (subst-ConvTm ws wfH c)

  -- conv-Id-irr
  subst-ConvTm ws wfH (conv-Id-irr d1 d2) =
    conv-Id-irr (subst-HasType ws wfH d1) (subst-HasType ws wfH d2)

  -- conv-cast-cong
  subst-ConvTm ws wfH (conv-cast-cong d1 d2 d3 d4 d5 d6 d7 d8 c1 c2 c3) =
    conv-cast-cong (subst-HasType ws wfH d1) (subst-HasType ws wfH d2)
                   (subst-HasType ws wfH d3) (subst-HasType ws wfH d4)
                   (subst-HasType ws wfH d5) (subst-HasType ws wfH d6)
                   (subst-HasType ws wfH d7) (subst-HasType ws wfH d8)
                   (subst-ConvTm ws wfH c1) (subst-ConvTm ws wfH c2) (subst-ConvTm ws wfH c3)

  -- conv-pi1
  subst-ConvTm ws wfH (conv-pi1 d1 d2 d3 d4 d5 c1 c2 c3 c4 c5) =
    let d1' = subst-HasType ws wfH d1
        d3' = subst-HasType ws wfH d3
    in conv-pi1 d1' (subst-HasType (liftSub-WtSub ws wfH d1) (wf-extend d1') d2)
                d3' (subst-HasType (liftSub-WtSub ws wfH d3) (wf-extend d3') d4)
                (subst-HasType ws wfH d5)
                (subst-ConvTm ws wfH c1) (subst-ConvTm (liftSub-WtSub ws wfH d1) (wf-extend d1') c2)
                (subst-ConvTm ws wfH c3) (subst-ConvTm (liftSub-WtSub ws wfH d3) (wf-extend d3') c4)
                (subst-ConvTm ws wfH c5)
  ...
  subst-ConvTm {H = H} {sigma = sigma} ws wfH
    ...
    let d1' = subst-HasType ws wfH d1
        d3' = subst-HasType ws wfH d3
        res = conv-pi2 d1' (subst-HasType (liftSub-WtSub ws wfH d1) (wf-extend d1') d2)
                       d3' (subst-HasType (liftSub-WtSub ws wfH d3) (wf-extend d3') d4)
                       (subst-HasType ws wfH d5) (subst-HasType ws wfH d6)
                       (subst-ConvTm ws wfH c1) (subst-ConvTm (liftSub-WtSub ws wfH d1) (wf-extend d1') c2)
                       (subst-ConvTm ws wfH c3) (subst-ConvTm (liftSub-WtSub ws wfH d3) (wf-extend d3') c4)
                       (subst-ConvTm ws wfH c5) (subst-ConvTm ws wfH c6)
    in Eq-transport (\ T -> ConvTm H (pi2 (substExpr sigma p) (substExpr sigma N))
                                     (pi2 (substExpr sigma p') (substExpr sigma N')) T)
         (Eq-cong2-Expr Id (subst-subst1-comm sigma B N)
                           (subst-subst1-comm sigma D (cast A C (pi1 p) N)))
         res
  ...
  subst-ConvTm {H = H} {sigma = sigma} ws wfH
    (conv-cast-Pi {A = A} {C = C} {B = B} {D = D} {p = p} {M = M} {N = N} dA dB dC dD dp dM dN) =
    let dA' = subst-HasType ws wfH dA
        dC' = subst-HasType ws wfH dC
        res = conv-cast-Pi dA' (subst-HasType (liftSub-WtSub ws wfH dA) (wf-extend dA') dB)
                           dC' (subst-HasType (liftSub-WtSub ws wfH dC) (wf-extend dC') dD)
                           (subst-HasType ws wfH dp) (subst-HasType ws wfH dM) (subst-HasType ws wfH dN)
        sNpr = cast (substExpr sigma C) (substExpr sigma A) (pi1 (sym (substExpr sigma p))) (substExpr sigma N)
        sM'  = substExpr sigma M
        q''  = sym (pi2 (sym (substExpr sigma p)) (substExpr sigma N))
        LHS' = App (cast (Pi (substExpr sigma A) (substExpr (liftSub sigma) B))
                         (Pi (substExpr sigma C) (substExpr (liftSub sigma) D))
                         (substExpr sigma p) sM') (substExpr sigma N)
        eqB  = subst-subst1-comm sigma B (cast C A (pi1 (sym p)) N)
        eqD  = subst-subst1-comm sigma D N
        step1 = Eq-transport
                  (\ X -> ConvTm H LHS'
                            (cast X (subst1 (substExpr (liftSub sigma) D) (substExpr sigma N)) q'' (App sM' sNpr))
                            (subst1 (substExpr (liftSub sigma) D) (substExpr sigma N)))
                  eqB res
    in Eq-transport
         (\ Y -> ConvTm H LHS'
                   (cast (substExpr sigma (subst1 B (cast C A (pi1 (sym p)) N))) Y q'' (App sM' sNpr)) Y)
         eqD step1
  ...
  -- conv-Id
  typing-ConvTm (conv-Id d1 d2 d3 d4 c1 c2) = mkSigma (ty-Id d1 d2) (ty-Id d3 d4)

  -- conv-cast-refl :  cast A B refl M  =  M : B
  typing-ConvTm (conv-cast-refl d1 d2 d3 c) =
    mkSigma (ty-cast d1 d2
              (ty-conv (ty-refl d1) (conv-Id d1 d1 d1 d2 (conv-refl d1) c) (ty-Id d1 d2))
              d3)
            (ty-conv d3 c d2)

  -- conv-Id-irr
  typing-ConvTm (conv-Id-irr d1 d2) = mkSigma d1 d2

  -- conv-cast-cong
  typing-ConvTm (conv-cast-cong d1 d2 d3 d4 d5 d6 d7 d8 c1 c2 c3) =
    mkSigma (ty-cast d1 d2 d3 d4)
            (ty-conv (ty-cast d5 d6 d7 d8) (conv-sym c2) d2)

  -- conv-pi1 : p' shares p's type, so the right side is ty-pi1 with p'
  typing-ConvTm (conv-pi1 d1 d2 d3 d4 d5 c1 c2 c3 c4 c5) =
    mkSigma (ty-pi1 d1 d2 d3 d4 d5)
            (ty-pi1 d1 d2 d3 d4 (snd (typing-ConvTm c5)))

  -- conv-pi2 : align the right side's dependent type (N' -> N, p' -> p)
  typing-ConvTm (conv-pi2 {A = A} {C = C} {B = B} {D = D} {p = p} {N = N}
                          d1 d2 d3 d4 d5 d6 c1 c2 c3 c4 c5 c6) =
    let dp'  = snd (typing-ConvTm c5)
        dN'  = snd (typing-ConvTm c6)
        wfG  = typing-WfCtx d1
        cast-p  = ty-cast d1 d3 (ty-pi1 d1 d2 d3 d4 d5) d6
        cast-p' = ty-cast d1 d3 (ty-pi1 d1 d2 d3 d4 dp') dN'
        -- Id-type of the LEFT side (pi2 p N)
        BN   = subst-HasType (subst1-WtSub d1 d6) wfG d2
        DcN  = subst-HasType (subst1-WtSub d3 cast-p) wfG d4
        leftU = ty-Id BN DcN
        -- components of the RIGHT side's type
        BN'  = subst-HasType (subst1-WtSub d1 dN') wfG d2
        DcN' = subst-HasType (subst1-WtSub d3 cast-p') wfG d4
        conv-BN : ConvTm _ (subst1 B N) (subst1 B N) U
        conv-BN = conv-refl BN
        -- subst1 B N' = subst1 B N  via N' = N
        conv-B  = subst1-cong-ConvTm d1 d2 dN' d6 (conv-sym c6)
        -- cast A C (pi1 p') N' = cast A C (pi1 p) N : C
        cast-conv = conv-cast-cong d1 d3 (ty-pi1 d1 d2 d3 d4 dp') dN'
                                   d1 d3 (ty-pi1 d1 d2 d3 d4 d5) d6
                                   (conv-refl d1) (conv-refl d3) (conv-sym c6)
        conv-D  = subst1-cong-ConvTm d3 d4 cast-p' cast-p cast-conv
        typeConv = conv-Id BN' DcN' BN DcN conv-B conv-D
    in mkSigma (ty-pi2 d1 d2 d3 d4 d5 d6)
               (ty-conv (ty-pi2 d1 d2 d3 d4 dp' dN') typeConv leftU)

  -- conv-cast-Pi : both sides at subst1 D N
  typing-ConvTm (conv-cast-Pi {A = A} {C = C} {B = B} {D = D} {p = p} {M = M} {N = N}
                              dA dB dC dD dp dM dN) =
    let wfG      = typing-WfCtx dA
        castType = ty-cast (ty-Pi dA dB) (ty-Pi dC dD) dp dM
        symp     = ty-sym (ty-Pi dA dB) (ty-Pi dC dD) dp
        pi1symp  = ty-pi1 dC dD dA dB symp
        dN'      = ty-cast dC dA pi1symp dN
        dsB      = subst-HasType (subst1-WtSub dA dN') wfG dB
        dsD      = subst-HasType (subst1-WtSub dC dN) wfG dD
        pi2symp  = ty-pi2 dC dD dA dB symp dN
        qprT     = ty-sym dsD dsB pi2symp
        dApp     = ty-App dA dB dM dN'
    in mkSigma (ty-App dC dD castType dN)
               (ty-cast dsB dsD qprT dApp)
  ...
  typing-WfCtx (ty-Id d _)         = typing-WfCtx d
  typing-WfCtx (ty-refl d)         = typing-WfCtx d
  typing-WfCtx (ty-sym d _ _)      = typing-WfCtx d
  typing-WfCtx (ty-pi1 d _ _ _ _)  = typing-WfCtx d
  typing-WfCtx (ty-pi2 d _ _ _ _ _) = typing-WfCtx d
  typing-WfCtx (ty-cast d _ _ _)   = typing-WfCtx d
  ...
  typing-type (ty-Id d1 _)            = ty-U (typing-WfCtx d1)
  typing-type (ty-refl d1)            = ty-Id d1 d1
  typing-type (ty-sym d1 d2 _)        = ty-Id d2 d1
  typing-type (ty-pi1 d1 _ d3 _ _)    = ty-Id d1 d3
  typing-type (ty-pi2 d1 d2 d3 d4 d5 d6) =
    ty-Id (subst-HasType (subst1-WtSub d1 d6) (typing-WfCtx d1) d2)
          (subst-HasType (subst1-WtSub d3 (ty-cast d1 d3 (ty-pi1 d1 d2 d3 d4 d5) d6))
                         (typing-WfCtx d1) d4)
  typing-type (ty-cast _ d2 _ _)      = d2
  ...
  -- ty-Id
  subst-ConvTm-cross (ty-Id d1 d2) ws ws' wcs wfH =
    conv-Id (subst-HasType ws wfH d1) (subst-HasType ws wfH d2)
            (subst-HasType ws' wfH d1) (subst-HasType ws' wfH d2)
            (subst-ConvTm-cross d1 ws ws' wcs wfH) (subst-ConvTm-cross d2 ws ws' wcs wfH)

  -- ty-refl : both sides are the closed term refl
  subst-ConvTm-cross (ty-refl d1) ws ws' wcs wfH =
    conv-refl (subst-HasType ws wfH (ty-refl d1))

  -- ty-pi1 (proof): proof irrelevance; type Id A C lives in the BASE ctx, so
  -- its cross is structural (conv-Id on the A- and C-crosses, no lifting).
  subst-ConvTm-cross (ty-pi1 d1 d2 d3 d4 d5) ws ws' wcs wfH =
    let typeCross = conv-Id (subst-HasType ws wfH d1) (subst-HasType ws wfH d3)
                            (subst-HasType ws' wfH d1) (subst-HasType ws' wfH d3)
                            (subst-ConvTm-cross d1 ws ws' wcs wfH)
                            (subst-ConvTm-cross d3 ws ws' wcs wfH)
    in conv-Id-irr (subst-HasType ws wfH (ty-pi1 d1 d2 d3 d4 d5))
         (ty-conv (subst-HasType ws' wfH (ty-pi1 d1 d2 d3 d4 d5))
           (conv-sym typeCross)
           (subst-HasType ws wfH (typing-type (ty-pi1 d1 d2 d3 d4 d5))))

  -- ty-pi2 : via conv-pi2 (codomain crosses lifted over A and C), transport
  -- the result type across the two subst1s.
  subst-ConvTm-cross {H = H} {sigma = sigma} {sigma' = sigma'}
    (ty-pi2 {A = A} {C = C} {B = B} {D = D} {p = p} {N = N} d1 d2 d3 d4 d5 d6) ws ws' wcs wfH =
    let dA   = subst-HasType ws wfH d1
        dA'  = subst-HasType ws' wfH d1
        cvA  = subst-ConvTm-cross d1 ws ws' wcs wfH
        wfHA = wf-extend dA
        ws2A = liftSub-WtSub ws wfH d1
        cvB  = subst-ConvTm-cross d2 ws2A
                 (\ i -> ctx-conv-HasType dA' dA (conv-sym cvA) (liftSub-WtSub ws' wfH d1 i))
                 (liftSub-WtConvSub ws wcs wfH d1) wfHA
        dC   = subst-HasType ws wfH d3
        dC'  = subst-HasType ws' wfH d3
        cvC  = subst-ConvTm-cross d3 ws ws' wcs wfH
        wfHC = wf-extend dC
        ws2C = liftSub-WtSub ws wfH d3
        cvD  = subst-ConvTm-cross d4 ws2C
                 (\ i -> ctx-conv-HasType dC' dC (conv-sym cvC) (liftSub-WtSub ws' wfH d3 i))
                 (liftSub-WtConvSub ws wcs wfH d3) wfHC
        res = conv-pi2 dA (subst-HasType ws2A wfHA d2) dC (subst-HasType ws2C wfHC d4)
                       (subst-HasType ws wfH d5) (subst-HasType ws wfH d6)
                       cvA cvB cvC cvD
                       (subst-ConvTm-cross d5 ws ws' wcs wfH)
  ...
  -- ty-sym (proof): proof irrelevance; type-cross built STRUCTURALLY (conv-Id
  -- on the component crosses d1,d2 — not via typing-type, to keep termination).
  subst-ConvTm-cross (ty-sym d1 d2 d3) ws ws' wcs wfH =
    let typeCross = conv-Id (subst-HasType ws wfH d2) (subst-HasType ws wfH d1)
                            (subst-HasType ws' wfH d2) (subst-HasType ws' wfH d1)
                            (subst-ConvTm-cross d2 ws ws' wcs wfH)
                            (subst-ConvTm-cross d1 ws ws' wcs wfH)
    in conv-Id-irr (subst-HasType ws wfH (ty-sym d1 d2 d3))
         (ty-conv (subst-HasType ws' wfH (ty-sym d1 d2 d3))
           (conv-sym typeCross)
           (subst-HasType ws wfH (typing-type (ty-sym d1 d2 d3))))

  -- ty-cast : congruence
  subst-ConvTm-cross (ty-cast d1 d2 d3 d4) ws ws' wcs wfH =
    conv-cast-cong (subst-HasType ws wfH d1) (subst-HasType ws wfH d2)
                   (subst-HasType ws wfH d3) (subst-HasType ws wfH d4)
                   (subst-HasType ws' wfH d1) (subst-HasType ws' wfH d2)
                   (subst-HasType ws' wfH d3) (subst-HasType ws' wfH d4)
                   (subst-ConvTm-cross d1 ws ws' wcs wfH)
                   (subst-ConvTm-cross d2 ws ws' wcs wfH)
                   (subst-ConvTm-cross d4 ws ws' wcs wfH)
