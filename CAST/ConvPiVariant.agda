...
-- d1.  Both lemmas already live in CAST.SubstitutionLemma.
--
...
module CAST.ConvPiVariant where

open import CAST.Basic using (Nat ; suc ; fst ; snd)
open import CAST.RawSyntax using (Expr ; U ; Pi)
open import CAST.TypingRules using (Ctx ; extend ; HasType ; ConvTm ;
  conv-Pi ; conv-sym)
open import CAST.SubstitutionLemma using (typing-ConvTm ; ctx-conv-HasType)
