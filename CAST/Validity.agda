...
open import CAST.TypingRules using (Ctx ; empty ; extend ; ConvTm ;
  conv-sym ; conv-trans)
open import CAST.Reduction using (Red ; mkRed ; HeadRed ; HeadRed-trans ;
  HeadRed-App ;
  HeadRed-strip-Pi ; HeadRed-unique-Pi)
open import CAST.PaperSemantics using (applyEl ; EvalFun ; EvalFun-step ;
  ...
  LeFunCode-refl)
open import CAST.Selection public
open import CAST.RawSemantics using (absurd)
