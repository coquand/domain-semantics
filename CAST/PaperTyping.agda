...
import CAST.FinMemStageProps as P
...
open CAST.FinMemStageUnfold using ( finMemC-bot-to ; finMemC-bot-from )
...
open CAST.FinMemStageUnfold public using ( FinMem-coh-u ; FinMem-a-in-U ; FinMem-coh-a ; coh-from-aU )
