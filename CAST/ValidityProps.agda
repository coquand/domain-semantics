...
-- same combinator+induction way as CAST.ValidityMono:
...
module CAST.ValidityProps where
...
open import CAST.Reduction using (Red ; mkRed ; Red-hr ; HeadRed ; headred-refl ; HeadRed-trans ;
  HeadRed-App ;
  HeadRed-strip-Pi )
...
open import CAST.SubstitutionLemma using (typing-ConvTm ; typing-type ; ctx-conv-ConvTm ; ctx-conv-HasType ;
  subst1-cong-ConvTm)
...
goodStageFwd (suc n) = record
  ...
  where
    ...
    Vfwd (IdCode _ _) UCode _ _ _ = tt
    Vfwd (IdCode _ _) (PiCode _ _) _ _ _ = tt
    Vfwd _ (IdCode _ _) _ _ _ = tt
    ...
    EVfwd (IdCode _ _) UCode _ _ _ = tt
    EVfwd (IdCode _ _) (PiCode _ _) _ _ _ = tt
    EVfwd _ (IdCode _ _) _ _ _ = tt
...
goodStageSymTrans (suc n) = record
  ...
  where
    ...
    EVsym (IdCode _ _) UCode _ _ _ = tt
    EVsym (IdCode _ _) (PiCode _ _) _ _ _ = tt
    EVsym _ (IdCode _ _) _ _ _ = tt
    ...
    EVtrans (IdCode _ _) UCode _ _ _ _ = tt
    EVtrans (IdCode _ _) (PiCode _ _) _ _ _ _ = tt
    EVtrans _ (IdCode _ _) _ _ _ _ = tt
...
goodStageSup (suc n) = record
  ...
  where
    ...
    VSup _ _ (IdCode _ _) Bot          _ _ _ _ _ = tt
    VSup _ _ (IdCode _ _) UCode        _ _ _ _ _ = tt
    VSup _ _ (IdCode _ _) (FunEl _)    _ _ _ _ _ = tt
    VSup _ _ (IdCode _ _) (PiCode _ _) _ _ _ _ _ = tt
    VSup _ _ (IdCode _ _) (IdCode _ _) _ _ _ _ _ = tt
    ...
    EVSup _ _ _ (IdCode _ _) Bot          _ _ _ _ _ = tt
    EVSup _ _ _ (IdCode _ _) UCode        _ _ _ _ _ = tt
    EVSup _ _ _ (IdCode _ _) (FunEl _)    _ _ _ _ _ = tt
    EVSup _ _ _ (IdCode _ _) (PiCode _ _) _ _ _ _ _ = tt
    EVSup _ _ _ (IdCode _ _) (IdCode _ _) _ _ _ _ _ = tt
...
goodStageRefl (suc n) = record
  ...
  where
    ...
    V2E u Bot v = tt
    V2E (IdCode _ _) UCode _ = tt
    V2E (IdCode _ _) (FunEl _) _ = tt
    V2E (IdCode _ _) (PiCode _ _) _ = tt
    V2E _ (IdCode _ _) _ = tt
    V2E Bot UCode v = tt
...
goodStageTransport (suc n) = record { Val2-type-transport = VTT ; EqVal2-type-transport = EVTT }
  where
    ...
    VTT (IdCode _ _) UCode _ _ = tt
    VTT (IdCode _ _) (PiCode _ _) _ _ = tt
    VTT _ (IdCode _ _) _ _ = tt
    ...
    EVTT (IdCode _ _) UCode _ _ = tt
    EVTT (IdCode _ _) (PiCode _ _) _ _ = tt
    EVTT _ (IdCode _ _) _ _ = tt
...
goodStageBeta (suc n) = record { Val2-beta-expand = Beta }
  where
    ...
    Beta (IdCode _ _) UCode _ _ _ = tt
    Beta (IdCode _ _) (PiCode _ _) _ _ _ = tt
    Beta _ (IdCode _ _) _ _ _ = tt
