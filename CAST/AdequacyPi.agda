...
open import CAST.PaperSemantics using (LeCode ; LeCode-refl ; Coherent ; Comp ;
...
open import CAST.SubstitutionLemma using (WtSub ; WtConvSub ; subst-HasType ; liftSub-WtSub)
open import CAST.EvalSubstitution using (EvalRel-unwk ; EvalRel-Pi-body)
...
Val2-U-to-ValTy2 (IdCode _ _) _ v = tt
...
EqVal2-U-to-EqValTy2 (IdCode _ _) _ ev = tt
