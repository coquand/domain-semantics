...
module CAST.LeqStageProps2 where
...
mutual
  ...
  Comp-down-n zero UCode        (IdCode b g) v cu cu' () c
  Comp-down-n zero (FunEl g)    u'           v () cu' le c
  Comp-down-n zero (PiCode a f) u'           v () cu' le c
  Comp-down-n zero (IdCode a b) u'           v () cu' le c
  -- n = suc m
  ...
  Comp-down-n (suc m) UCode        (IdCode b g) v cu cu' () c
  ...
  Comp-down-n (suc m) (FunEl g)    (FunEl h)    (IdCode b k) cu cu' le ()
  Comp-down-n (suc m) (FunEl g)    (PiCode b h) v cu cu' () c
  Comp-down-n (suc m) (FunEl g)    (IdCode b h) v cu cu' () c
  ...
  Comp-down-n (suc m) (PiCode a f) (PiCode b g) (PiCode c2 k) cu cu' le comp =
    mkSigma
      ...
      (LeFunCode-CompFun-trans-n m f g k
        ...
        (snd le) (snd comp))
  Comp-down-n (suc m) (PiCode a f) (PiCode b g) (IdCode c2 k) cu cu' le ()
  Comp-down-n (suc m) (PiCode a f) (IdCode b g) v cu cu' () c
  Comp-down-n (suc m) (IdCode a1 a2) Bot          v cu cu' () c
  Comp-down-n (suc m) (IdCode a1 a2) UCode        v cu cu' () c
  Comp-down-n (suc m) (IdCode a1 a2) (FunEl h)    v cu cu' () c
  Comp-down-n (suc m) (IdCode a1 a2) (PiCode b g) v cu cu' () c
  Comp-down-n (suc m) (IdCode a1 a2) (IdCode b1 b2) Bot          cu cu' le c = tt
  Comp-down-n (suc m) (IdCode a1 a2) (IdCode b1 b2) UCode        cu cu' le ()
  Comp-down-n (suc m) (IdCode a1 a2) (IdCode b1 b2) (FunEl j)    cu cu' le ()
  Comp-down-n (suc m) (IdCode a1 a2) (IdCode b1 b2) (PiCode c1 k) cu cu' le ()
  Comp-down-n (suc m) (IdCode a1 a2) (IdCode b1 b2) (IdCode c1 c2) cu cu' le comp =
    mkSigma
      (Comp-down-n m a1 b1 c1
        (max-Le-l (RANK a1) (RANK a2) m cu)
        (max-Le-l (RANK b1) (RANK b2) m cu')
        (fst le) (fst comp))
      (Comp-down-n m a2 b2 c2
        (max-Le-r (RANK a1) (RANK a2) m cu)
        (max-Le-r (RANK b1) (RANK b2) m cu')
        (snd le) (snd comp))
...
mutual
  ...
  LeCode-refl-n zero    (IdCode a b) ()   ca
  ...
  LeCode-refl-n (suc m) (IdCode a b) cond ca =
    mkSigma (LeCode-refl-n m a (max-Le-l (RANK a) (RANK b) m cond) (fst ca))
            (LeCode-refl-n m b (max-Le-r (RANK a) (RANK b) m cond) (snd ca))
  ...
  LeCode-Sup-left-n zero UCode        (IdCode d h) ba ()   comp ca cb
  LeCode-Sup-left-n zero (FunEl g)    b            () bb   comp ca cb
  LeCode-Sup-left-n zero (PiCode a f) b            () bb   comp ca cb
  LeCode-Sup-left-n zero (IdCode a b) c            () bb   comp ca cb
  -- suc
  ...
  LeCode-Sup-left-n (suc m) UCode        (IdCode d h) ba bb () ca cb
  ...
  LeCode-Sup-left-n (suc m) (FunEl g)    (IdCode d h) ba bb () ca cb
  ...
  LeCode-Sup-left-n (suc m) (PiCode a f) (IdCode d h) ba bb () ca cb
  LeCode-Sup-left-n (suc m) (IdCode a1 a2) Bot          ba bb comp ca cb =
    LeCode-refl-n (suc m) (IdCode a1 a2) ba ca
  LeCode-Sup-left-n (suc m) (IdCode a1 a2) UCode        ba bb () ca cb
  LeCode-Sup-left-n (suc m) (IdCode a1 a2) (FunEl h)    ba bb () ca cb
  LeCode-Sup-left-n (suc m) (IdCode a1 a2) (PiCode d h) ba bb () ca cb
  LeCode-Sup-left-n (suc m) (IdCode a1 a2) (IdCode d1 d2) ba bb comp ca cb =
    mkSigma
      (LeCode-Sup-left-n m a1 d1
        (max-Le-l (RANK a1) (RANK a2) m ba) (max-Le-l (RANK d1) (RANK d2) m bb)
        (fst comp) (fst ca) (fst cb))
      (LeCode-Sup-left-n m a2 d2
        (max-Le-r (RANK a1) (RANK a2) m ba) (max-Le-r (RANK d1) (RANK d2) m bb)
        (snd comp) (snd ca) (snd cb))
  ...
  LeCode-Sup-right-n zero (IdCode a b) UCode        () bb comp ca cb
  LeCode-Sup-right-n zero a            (FunEl h)    ba () comp ca cb
  LeCode-Sup-right-n zero a            (PiCode d h) ba () comp ca cb
  LeCode-Sup-right-n zero a            (IdCode d h) ba () comp ca cb
  -- suc
  ...
  LeCode-Sup-right-n (suc m) (IdCode a b) UCode        ba bb () ca cb
  ...
  LeCode-Sup-right-n (suc m) (IdCode a b) (FunEl h)    ba bb () ca cb
  ...
  LeCode-Sup-right-n (suc m) (PiCode a f) (PiCode d h) ba bb comp ca cb =
    mkSigma
      ...
      (LeFunCode-append-right-n m f h
        (max-Le-r (RANK a) (RANKFun f) m ba) (max-Le-r (RANK d) (RANKFun h) m bb)
        (snd comp) (snd ca) (snd cb))
  LeCode-Sup-right-n (suc m) (IdCode a b) (PiCode d h) ba bb () ca cb
  LeCode-Sup-right-n (suc m) Bot          (IdCode d1 d2) ba bb comp ca cb =
    LeCode-refl-n (suc m) (IdCode d1 d2) bb cb
  LeCode-Sup-right-n (suc m) UCode        (IdCode d1 d2) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (FunEl g)    (IdCode d1 d2) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (PiCode a f) (IdCode d1 d2) ba bb () ca cb
  LeCode-Sup-right-n (suc m) (IdCode a1 a2) (IdCode d1 d2) ba bb comp ca cb =
    mkSigma
      (LeCode-Sup-right-n m a1 d1
        (max-Le-l (RANK a1) (RANK a2) m ba) (max-Le-l (RANK d1) (RANK d2) m bb)
        (fst comp) (fst ca) (fst cb))
      (LeCode-Sup-right-n m a2 d2
        (max-Le-r (RANK a1) (RANK a2) m ba) (max-Le-r (RANK d1) (RANK d2) m bb)
        (snd comp) (snd ca) (snd cb))
  ...
  LeCode-trans-n zero    UCode (IdCode b g) z bx by bz cx cy cz () yz
  ...
  LeCode-trans-n (suc m) UCode (IdCode b g) z bx by bz cx cy cz () yz
  -- FunEl
  ...
  LeCode-trans-n (suc m) (FunEl g) (FunEl h) (IdCode c k) bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (FunEl g) (PiCode b h) z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (FunEl g) (IdCode b h) z bx by bz cx cy cz () yz
  -- PiCode
  ...
  LeCode-trans-n (suc m) (PiCode a f) (PiCode b g) (IdCode c k) bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (PiCode a f) (IdCode b g) z bx by bz cx cy cz () yz
  -- IdCode
  LeCode-trans-n zero    (IdCode a b) y z () by bz cx cy cz xy yz
  LeCode-trans-n (suc m) (IdCode a b) Bot          z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (IdCode a b) UCode        z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (IdCode a b) (FunEl h)    z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (IdCode a b) (PiCode b' g) z bx by bz cx cy cz () yz
  LeCode-trans-n (suc m) (IdCode a1 a2) (IdCode b1 b2) Bot          bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (IdCode a1 a2) (IdCode b1 b2) UCode        bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (IdCode a1 a2) (IdCode b1 b2) (FunEl k)    bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (IdCode a1 a2) (IdCode b1 b2) (PiCode c k) bx by bz cx cy cz xy ()
  LeCode-trans-n (suc m) (IdCode a1 a2) (IdCode b1 b2) (IdCode c1 c2) bx by bz cx cy cz xy yz =
    mkSigma
      (LeCode-trans-n m a1 b1 c1
        (max-Le-l (RANK a1) (RANK a2) m bx) (max-Le-l (RANK b1) (RANK b2) m by)
        (max-Le-l (RANK c1) (RANK c2) m bz)
        (fst cx) (fst cy) (fst cz) (fst xy) (fst yz))
      (LeCode-trans-n m a2 b2 c2
        (max-Le-r (RANK a1) (RANK a2) m bx) (max-Le-r (RANK b1) (RANK b2) m by)
        (max-Le-r (RANK c1) (RANK c2) m bz)
        (snd cx) (snd cy) (snd cz) (snd xy) (snd yz))
