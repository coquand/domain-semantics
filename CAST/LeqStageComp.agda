...
module CAST.LeqStageComp where
...
IdCode-cong : {a b c d : FinEl} ->
  Eq a c -> Eq b d -> Eq (IdCode a b) (IdCode c d)
IdCode-cong refl refl = refl
...
comp-Sup UCode UCode (IdCode e j)    ab ac = tt
comp-Sup UCode (FunEl h) c () ac
comp-Sup UCode (PiCode d k) c () ac
comp-Sup UCode (IdCode d k) c () ac
...
comp-Sup (FunEl g) (FunEl h) (IdCode d k) ab ()
comp-Sup (FunEl g) (PiCode d k) c () ac
comp-Sup (FunEl g) (IdCode d k) c () ac
...
comp-Sup (PiCode a f) (PiCode d k) (IdCode e j) ab ()
comp-Sup (PiCode a f) (IdCode d k) c () ac
comp-Sup (IdCode a b) Bot c ab ac = ac
comp-Sup (IdCode a b) UCode c () ac
comp-Sup (IdCode a b) (FunEl h) c () ac
comp-Sup (IdCode a b) (PiCode d k) c () ac
comp-Sup (IdCode a b) (IdCode d k) Bot ab ac = ab
comp-Sup (IdCode a b) (IdCode d k) UCode ab ()
comp-Sup (IdCode a b) (IdCode d k) (FunEl h) ab ()
comp-Sup (IdCode a b) (IdCode d k) (PiCode e j) ab ()
comp-Sup (IdCode a b) (IdCode d k) (IdCode e j) ab ac =
  mkSigma (comp-Sup a d e (fst ab) (fst ac))
          (comp-Sup b k j (snd ab) (snd ac))
...
mutual
  ...
  Comp-sym (PiCode a f) (IdCode b g) ()
  Comp-sym (IdCode a b) Bot c = tt
  Comp-sym (IdCode a b) UCode ()
  Comp-sym (IdCode a b) (FunEl h) ()
  Comp-sym (IdCode a b) (PiCode c g) ()
  Comp-sym (IdCode a b) (IdCode c d) cc =
    mkSigma (Comp-sym a c (fst cc)) (Comp-sym b d (snd cc))
...
mutual
  ...
  Comp-refl (IdCode a b) coh =
    mkSigma (Comp-refl a (fst coh)) (Comp-refl b (snd coh))
...
NotBot-Sup-Comp UCode (IdCode b g) nb ()
...
NotBot-Sup-Comp (FunEl g) (IdCode b h) nb ()
...
NotBot-Sup-Comp (PiCode a f) (IdCode b g) nb ()
NotBot-Sup-Comp (IdCode a b) Bot nb c = tt
NotBot-Sup-Comp (IdCode a b) UCode nb ()
NotBot-Sup-Comp (IdCode a b) (FunEl h) nb ()
NotBot-Sup-Comp (IdCode a b) (PiCode c g) nb ()
NotBot-Sup-Comp (IdCode a b) (IdCode c d) nb c' = tt
...
Sup-assoc UCode UCode (IdCode e j) cab ()
Sup-assoc UCode (FunEl h) c () cbc
Sup-assoc UCode (PiCode d h) c () cbc
Sup-assoc UCode (IdCode d h) c () cbc
...
Sup-assoc (FunEl g) (FunEl h) (IdCode e j) cab ()
Sup-assoc (FunEl g) (PiCode d h) c () cbc
Sup-assoc (FunEl g) (IdCode d h) c () cbc
...
Sup-assoc (PiCode a f) (PiCode d h) (IdCode e j) cab ()
Sup-assoc (PiCode a f) (IdCode d h) c () cbc
Sup-assoc (IdCode a b) Bot c cab cbc = refl
Sup-assoc (IdCode a b) UCode c () cbc
Sup-assoc (IdCode a b) (FunEl h) c () cbc
Sup-assoc (IdCode a b) (PiCode d h) c () cbc
Sup-assoc (IdCode a b) (IdCode d h) Bot cab cbc = refl
Sup-assoc (IdCode a b) (IdCode d h) UCode cab ()
Sup-assoc (IdCode a b) (IdCode d h) (FunEl j) cab ()
Sup-assoc (IdCode a b) (IdCode d h) (PiCode e j) cab ()
Sup-assoc (IdCode a b) (IdCode d h) (IdCode e j) cab cbc =
  IdCode-cong (Sup-assoc a d e (fst cab) (fst cbc))
              (Sup-assoc b h j (snd cab) (snd cbc))
...
mutual
  ...
  Coherent-Sup UCode (IdCode c h) () coha cohb
  ...
  Coherent-Sup (FunEl g) (IdCode c h) () coha cohb
  ...
  Coherent-Sup (PiCode a f) (IdCode c h) () coha cohb
  Coherent-Sup (IdCode a b) Bot comp coha cohb = coha
  Coherent-Sup (IdCode a b) UCode () coha cohb
  Coherent-Sup (IdCode a b) (FunEl h) () coha cohb
  Coherent-Sup (IdCode a b) (PiCode c h) () coha cohb
  Coherent-Sup (IdCode a b) (IdCode c d) comp coha cohb =
    mkSigma (Coherent-Sup a c (fst comp) (fst coha) (fst cohb))
            (Coherent-Sup b d (snd comp) (snd coha) (snd cohb))
