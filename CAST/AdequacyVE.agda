...
module CAST.AdequacyVE where

open import CAST.AdequacyHeadRed
open import CAST.AdequacyPi using (Adq ; AdqConv ; adequacy-ty-Pi ;
...
open import CAST.PaperSemantics using (LeCode ; LeCode-refl ; Coherent ; coh-from-aU ;
...
open import CAST.RawSemantics using (EnvApprox ; extendEnv ; EvalRel ; EvalRel-coh ;
  CoherentEnv ; EvalRel-Comp)
open import CAST.TypingSemantics using (convSound ; convSound-inv)
open import CAST.RawSyntax using (Expr ; U ; Pi ; subst1 ; Sub ; liftSub ; substExpr)
...
open import CAST.SubstitutionLemma using (WtSub ; WtConvSub ; subst-HasType ; typing-ConvTm ;
...
open import CAST.RawSemantics using (EvalRel-mon-env ; EnvLe-refl)
...
open import CAST.TypingRules using (ty-conv)
...
EqVal2-U-to-ValTy2-fst (IdCode _ _) _ ev = tt
...
EqVal2-U-to-ValTy2-snd (IdCode _ _) _ ev = tt
