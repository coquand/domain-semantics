...
module CAST.AdequacyBundle where

open import CAST.AdequacyHeadRed
open import CAST.AdequacyVE public

import CAST.Basic as S
open S using (Nat ; zero ; suc ; tt ; Pair ; mkSigma ; fst ; snd ; FinEl ; UCode ; Bot ; FunEl ; PiCode)
open import CAST.RawSyntax using (Expr ; Var ; U ; Pi ; Lam ; App ; subst1 ; Fin ; fzero ; fsuc ; Sub ; liftSub ; substExpr ; wkExpr)
open import CAST.RawSemantics using (EnvApprox ; EvalRel ; CoherentEnv ; lookupEnv ; extendEnv ;
  EvalRel-Comp ; EvalRel-mon-env ; EvalRel-down ; EnvLe-refl)
open import CAST.PaperSemantics using (Coherent ; FinMem ; LeCode ; LeCode-refl ; FinMem-a-in-U ;
...
open import CAST.TypingRules using (Ctx ; lookup ; HasType ; ConvTm ; WfCtx ; wf-extend ; ty-var ;
  ty-U ; ty-Pi ; ty-Lam ; ty-conv ; conv-refl ; conv-sym ; conv-conv)
open import CAST.Selection using (FinMemAllU-Selection ; FinMem-Selection-UCode)
open import CAST.AdequacyPi using (EqVal2-U-to-EqValTy2 ; AdqConv ; Adq ; transportVal2' ;
  Val2-U-to-ValTy2 ; sup-transport-EqVal2 ; adequacy-ty-Pi)
open import CAST.Basic using (FinFun)
open import CAST.AdequacyLam using (adequacyV-ty-Lam ; lamTypeTwoSub ; adequacy-ty-Lam)
open import CAST.AdequacyApp using (adequacyV-ty-App ; adequacyV-subst1-cod ; AdSub2Rec ; AdConvSub2Rec)
open import CAST.AdequacyAppInj using (adequacyV-ty-App-inj ; adequacyV-subst1-cod-inj)
open import CAST.AdequacyArgCore using (adequacyEqSub2-App-arg ; AdEqSub2Rec)
...
open import CAST.Reduction using (headred-refl)
open import CAST.SubstitutionLemma using (WtSub ; WtConvSub ; typing-ConvTm ; subst-HasType ;
  subst-ConvTm ; subst-ConvTm-cross ; liftSub-WtSub ; liftSub-WtConvSub ; ctx-conv-HasType)
open import CAST.LemmaForTS using (Fits)
open import CAST.RawSemantics using (EvalRel-coh)
open import CAST.TypingSemantics using (convSound ; convSound-inv)
open import CAST.Validity using (FinMem-Coherent)
open import CAST.EvalSubstitution using (EvalRel-unwk)
open import CAST.TypingRules using (extend)
