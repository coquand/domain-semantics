...
module CAST.AdequacyBeta where
open import CAST.AdequacyHeadRed

open import CAST.AdequacyPi using (Adq)

import CAST.Basic as S
open S using (Nat ; suc ; tt ; mkSigma ; fst ; snd ; FinEl)
open import CAST.PaperSemantics using (FinMem ; Comp ; Sup ; Coherent-Sup ;
...
open import CAST.RawSyntax using (Expr ; U ; Pi ; Lam ; App ; subst1 ; Sub ; liftSub ; substExpr)
open import CAST.TypingRules using (Ctx ; extend ; HasType ; ConvTm ; WfCtx ; wf-extend ;
  conv-beta ; conv-refl)
open import CAST.Reduction using (HeadRed ; headred-step ; headred-beta ; headred-refl ; subst-subst1-comm)
open import CAST.SubstitutionLemma using (WtSub ; subst-HasType ; liftSub-WtSub ; typing-ConvTm)
