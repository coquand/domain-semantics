...
-- head-expansion family (CAST.ValidityHeadRed).
--
...
module CAST.AdequacyHeadRed where
open import CAST.AdequacyHelpers public
open import CAST.ValidityHeadRed public
  using (Val2-headred-contract ; EqVal2-headred-contract ; EqVal2-headred-expand)

open import CAST.Basic using (Nat ; FinEl)
