...
module CAST.FinMemStageStable where
...
goodMemStab (suc m) =
  ...
  where
    ...
    fmF Bot          (PiCode a f) bu ba mem =
      ...
      in mkSigma (ihmF a UCode bd (Le0 m) (fst mem))
                 (mkSigma (faF f a (Le-max-lub (RANKFun f) (RANK a) m bk bd)
                            (fst (snd mem)))
                          (snd (snd mem)))
    fmF Bot          (IdCode a b) bu ba mem =
      mkSigma (ihmF a UCode (max-Le-l (RANK a) (RANK b) m ba) (Le0 m) (fst mem))
              (ihmF b UCode (max-Le-r (RANK a) (RANK b) m ba) (Le0 m) (snd mem))
    fmF UCode        Bot          bu ba ()
    fmF UCode        UCode        bu ba mem = mem
    fmF UCode        (FunEl g)    bu ba ()
    fmF UCode        (PiCode a f) bu ba ()
    fmF UCode        (IdCode a b) bu ba ()
    ...
    fmF (PiCode a f) (IdCode b d) bu ba ()
    fmF (IdCode a b) Bot          bu ba ()
    fmF (IdCode a b) UCode        bu ba mem =
      mkSigma (ihmF a UCode (max-Le-l (RANK a) (RANK b) m bu) (Le0 m) (fst mem))
              (ihmF b UCode (max-Le-r (RANK a) (RANK b) m bu) (Le0 m) (snd mem))
    fmF (IdCode a b) (FunEl g)    bu ba ()
    fmF (IdCode a b) (PiCode c g) bu ba ()
    fmF (IdCode a b) (IdCode c d) bu ba ()
    ...
    fmB Bot          (PiCode a f) bu ba mem =
      ...
      in mkSigma (ihmB a UCode bd (Le0 m) (fst mem))
                 (mkSigma (faB f a (Le-max-lub (RANKFun f) (RANK a) m bk bd)
                            (fst (snd mem)))
                          (snd (snd mem)))
    fmB Bot          (IdCode a b) bu ba mem =
      mkSigma (ihmB a UCode (max-Le-l (RANK a) (RANK b) m ba) (Le0 m) (fst mem))
              (ihmB b UCode (max-Le-r (RANK a) (RANK b) m ba) (Le0 m) (snd mem))
    fmB UCode        Bot          bu ba ()
    fmB UCode        UCode        bu ba mem = mem
    fmB UCode        (FunEl g)    bu ba ()
    fmB UCode        (PiCode a f) bu ba ()
    fmB UCode        (IdCode a b) bu ba ()
    ...
    fmB (PiCode a f) (IdCode b d) bu ba ()
    fmB (IdCode a b) Bot          bu ba ()
    fmB (IdCode a b) UCode        bu ba mem =
      mkSigma (ihmB a UCode (max-Le-l (RANK a) (RANK b) m bu) (Le0 m) (fst mem))
              (ihmB b UCode (max-Le-r (RANK a) (RANK b) m bu) (Le0 m) (snd mem))
    fmB (IdCode a b) (FunEl g)    bu ba ()
    fmB (IdCode a b) (PiCode c g) bu ba ()
    fmB (IdCode a b) (IdCode c d) bu ba ()
