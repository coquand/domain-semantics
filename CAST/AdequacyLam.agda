...
module CAST.AdequacyLam where

open import CAST.AdequacyHeadRed
open import CAST.AdequacyPi using (Adq ; AdqConv ; transportVal2' ; transportEqVal2' ;
  Val2-U-to-ValTy2 ; EqVal2-U-to-EqValTy2)
open import CAST.AdequacyVE using (adequacyV-ty-Pi)
...
open import CAST.RawSyntax using (Expr ; U ; Pi ; Lam ; subst1 ; Sub ; liftSub ; substExpr)
...
open import CAST.Reduction using (headred-refl ; headred-step ; headred-beta)
open import CAST.Selection using (FinMem-Selection ; FinMem-Selection-codomain ; Coherent-Selection)
open import CAST.EvalSubstitution using (EvalRel-Pi-body)
