...
module CAST.SelectionRank where

open import CAST.Basic
  using (FinEl ; Bot ; FinFun ; nil ; cons ; fst ; snd ; tt ; max ;
         Le ; Le-trans ; Le-max-l ; Le-max-r)
open import CAST.PaperSemantics using (Sup)
open import CAST.Selection using (Selection ; sel-nil ; sel-skip ; sel-take ; Edge)
open import CAST.Rank using (RANK ; RANKFun ; RANK-Sup ; Le-max-lub)
