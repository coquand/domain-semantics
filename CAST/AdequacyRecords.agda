...
module CAST.AdequacyRecords where
...
open import CAST.Basic
  using (Nat ; zero ; suc ; Top ; tt ; Pair ; mkSigma ; fst ; snd ;
         ...
         Eq-transport ; Eq-sym)
open import CAST.RawSyntax using (Expr ; Pi ; U ; App ; subst1)
...
open import CAST.ValidityLevels using (shiftVTy ; shiftEVTy ; shiftVl ; shiftEVl)
