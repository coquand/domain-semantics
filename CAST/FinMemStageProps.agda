...
module CAST.FinMemStageProps where
...
open import CAST.FinMemStage
open import CAST.FinMemStageUnfold
...
mutual
  ...
  finMemUCode-Sup-k k UCode        (IdCode c h) ba bc () aU cU
  ...
  finMemUCode-Sup-k k (PiCode a f) (IdCode c h) ba bc () aU cU
  finMemUCode-Sup-k k (IdCode a b) Bot          ba bc comp aU cU = aU
  finMemUCode-Sup-k k (IdCode a b) UCode        ba bc () aU cU
  finMemUCode-Sup-k k (IdCode a b) (FunEl h)    ba bc () aU cU
  finMemUCode-Sup-k k (IdCode a b) (PiCode c h) ba bc () aU cU
  finMemUCode-Sup-k zero    (IdCode a b) (IdCode c d) () bc comp aU cU
  finMemUCode-Sup-k (suc k) (IdCode a b) (IdCode c d) ba bc comp aU cU =
    let ba1 = max-Le-l (RANK a) (RANK b) k ba
        ba2 = max-Le-r (RANK a) (RANK b) k ba
        bc1 = max-Le-l (RANK c) (RANK d) k bc
        bc2 = max-Le-r (RANK c) (RANK d) k bc
        a1U = finMemC-idU-dom a b aU ; a2U = finMemC-idU-cod a b aU
        c1U = finMemC-idU-dom c d cU ; c2U = finMemC-idU-cod c d cU
    in finMemC-idU-mk (Sup a c) (Sup b d)
         (finMemUCode-Sup-k k a c ba1 bc1 (fst comp) a1U c1U)
         (finMemUCode-Sup-k k b d ba2 bc2 (snd comp) a2U c2U)
  ...
  finMem-Sup-right-k k (IdCode d kk) UCode UCode ba bb bu () aU cohu mem
  ...
  finMem-Sup-right-k k a (IdCode c h) UCode ba bb bu comp aU cohu ()
  ...
  finMem-Sup-right-k k a (IdCode c h) (PiCode b' h') ba bb bu comp aU cohu ()
  ...
  finMem-Sup-right-k k a (IdCode c h) (FunEl g) ba bb bu comp aU cohu ()
  -- u = IdCode: member only of UCode, so only b = UCode is inhabited
  finMem-Sup-right-k k Bot          UCode (IdCode u1 u2) ba bb bu comp aU cohu mem = mem
  finMem-Sup-right-k k UCode        UCode (IdCode u1 u2) ba bb bu comp aU cohu mem = mem
  finMem-Sup-right-k k (FunEl g)    UCode (IdCode u1 u2) ba bb bu comp () cohu mem
  finMem-Sup-right-k k (PiCode d kk) UCode (IdCode u1 u2) ba bb bu () aU cohu mem
  finMem-Sup-right-k k (IdCode d kk) UCode (IdCode u1 u2) ba bb bu () aU cohu mem
  finMem-Sup-right-k k a Bot          (IdCode u1 u2) ba bb bu comp aU cohu ()
  finMem-Sup-right-k k a (FunEl h)    (IdCode u1 u2) ba bb bu comp aU cohu ()
  finMem-Sup-right-k k a (PiCode c h) (IdCode u1 u2) ba bb bu comp aU cohu ()
  finMem-Sup-right-k k a (IdCode c d) (IdCode u1 u2) ba bb bu comp aU cohu ()
  ...
  finMem-Sup-left-k (suc k) (PiCode d kk) (PiCode c h) (FunEl g) ba bb bu comp coha cohb bU cohu mem =
    ...
    in finMemC-funel-mk g (Sup d c) (append kk h)
         ...
         (finMemC-piU-mk (Sup d c) (append kk h) supU allUkh cohkh)
  -- IdCode-as-type additions to the existing u-branches
  finMem-Sup-left-k k UCode        (IdCode c h) UCode         ba bb bu () coha cohb bU cohu mem
  finMem-Sup-left-k k (IdCode a f) b            UCode         ba bb bu comp coha cohb bU cohu ()
  finMem-Sup-left-k k UCode        (IdCode c h) (PiCode b' h') ba bb bu () coha cohb bU cohu mem
  finMem-Sup-left-k k (IdCode a f) b            (PiCode b' h') ba bb bu comp coha cohb bU cohu ()
  finMem-Sup-left-k k (PiCode d kk) (IdCode c h) (FunEl g)    ba bb bu () coha cohb bU cohu mem
  finMem-Sup-left-k k (IdCode a f) b            (FunEl g)     ba bb bu comp coha cohb bU cohu ()
  -- u = IdCode: member only of UCode (a = UCode)
  finMem-Sup-left-k k UCode        Bot          (IdCode u1 u2) ba bb bu comp coha cohb bU cohu mem = mem
  finMem-Sup-left-k k UCode        UCode        (IdCode u1 u2) ba bb bu comp coha cohb bU cohu mem = mem
  finMem-Sup-left-k k UCode        (FunEl h)    (IdCode u1 u2) ba bb bu () coha cohb bU cohu mem
  finMem-Sup-left-k k UCode        (PiCode c h) (IdCode u1 u2) ba bb bu () coha cohb bU cohu mem
  finMem-Sup-left-k k UCode        (IdCode c h) (IdCode u1 u2) ba bb bu () coha cohb bU cohu mem
  finMem-Sup-left-k k Bot          b            (IdCode u1 u2) ba bb bu comp coha cohb bU cohu ()
  finMem-Sup-left-k k (FunEl g)    b            (IdCode u1 u2) ba bb bu comp coha cohb bU cohu ()
  finMem-Sup-left-k k (PiCode a f) b            (IdCode u1 u2) ba bb bu comp coha cohb bU cohu ()
  finMem-Sup-left-k k (IdCode a f) b            (IdCode u1 u2) ba bb bu comp coha cohb bU cohu ()
...
mutual
  ...
  finMem-upward (PiCode a f) UCode        (IdCode c h) ()
  ...
  finMem-upward (PiCode a f) (IdCode c h) b            le ca cb ()
  finMem-upward (IdCode v1 v2) UCode        UCode        le ca cb mem bU = mem
  finMem-upward (IdCode v1 v2) UCode        Bot          ()
  finMem-upward (IdCode v1 v2) UCode        (FunEl h)    ()
  finMem-upward (IdCode v1 v2) UCode        (PiCode c h) ()
  finMem-upward (IdCode v1 v2) UCode        (IdCode c h) ()
  finMem-upward (IdCode v1 v2) Bot          b            le ca cb ()
  finMem-upward (IdCode v1 v2) (FunEl g)    b            le ca cb ()
  finMem-upward (IdCode v1 v2) (PiCode c h) b            le ca cb ()
  finMem-upward (IdCode v1 v2) (IdCode c h) b            le ca cb ()
...
FinMem-Sup-element (IdCode u1 u2) Bot a comp ca mu mv = mu
...
FinMem-Sup-element (FunEl g)    (FunEl h) (IdCode b f) comp ca () mv
FinMem-Sup-element (PiCode a1 f1) UCode a () ca mu mv
FinMem-Sup-element (PiCode a1 f1) (FunEl h) a () ca mu mv
FinMem-Sup-element (PiCode a1 f1) (IdCode b f) a () ca mu mv
...
FinMem-Sup-element (PiCode a1 f1) (PiCode a2 f2) (IdCode b f) comp ca () mv
FinMem-Sup-element (IdCode u1 u2) UCode a () ca mu mv
FinMem-Sup-element (IdCode u1 u2) (FunEl h) a () ca mu mv
FinMem-Sup-element (IdCode u1 u2) (PiCode b f) a () ca mu mv
FinMem-Sup-element (IdCode u1 u2) (IdCode v1 v2) Bot comp ca () mv
FinMem-Sup-element (IdCode u1 u2) (IdCode v1 v2) UCode comp ca mu mv =
  finMemUCode-Sup (IdCode u1 u2) (IdCode v1 v2) comp mu mv
FinMem-Sup-element (IdCode u1 u2) (IdCode v1 v2) (FunEl h) comp ca () mv
FinMem-Sup-element (IdCode u1 u2) (IdCode v1 v2) (PiCode b f) comp ca () mv
FinMem-Sup-element (IdCode u1 u2) (IdCode v1 v2) (IdCode b f) comp ca () mv
